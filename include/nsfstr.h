...
/*                                                                   */
/* Copyright IBM Corp. 2005, 2018  All Rights Reserved.              */
...
#define STR_UNABLE_TO_BRING_ONLINE		PKG_NSF_STR2+9
	stringtext(STR_UNABLE_TO_BRING_ONLINE, 	"Unable to bring %p online")

#define ERR_IMAPMNT_PROCESSING				PKG_NSF_STR2+10
	stringtext(ERR_IMAPMNT_PROCESSING,		"IMAP Maint - Processing database: %p (%s), %s, IMAP %s, FolderSync %s")
#define ERR_IMAPMNT_NAMETABLE_ERROR			PKG_NSF_STR2+11
	stringtext(ERR_IMAPMNT_NAMETABLE_ERROR,	"IMAP Maint - Database %s needs compact, error: %s")
#define ERR_IMAPMNT_FILE_ERR				PKG_NSF_STR2+12
	stringtext(ERR_IMAPMNT_FILE_ERR,			"IMAP Maint: Unable to repair database %p")
#define ERR_IMAPMNT_FILE_ALT				PKG_NSF_STR2+13
	stringtext(ERR_IMAPMNT_FILE_ALT,		"IMAP Maint - Processing database %p")
#define ERR_IMAPMNT_FILE_ALT2				PKG_NSF_STR2+14
	stringtext(ERR_IMAPMNT_FILE_ALT2,		"IMAP Maint - Processing directory %p")
#define ERR_IMAPMNT_FILE_ALT3				PKG_NSF_STR2+15
	stringtext(ERR_IMAPMNT_FILE_ALT3,		"IMAP Maint - Processing database %s, folder %s")
#define ERR_IMAPMNT_DOESNOTEXIST			PKG_NSF_STR2+16
	stringtext(ERR_IMAPMNT_DOESNOTEXIST,		"IMAP Maint - The pathname '%s' was not found")
#define ERR_IMAPMNT_VERIFY_ERROR			PKG_NSF_STR2+17
	stringtext(ERR_IMAPMNT_VERIFY_ERROR,		"IMAP Maint - Verify/Dump error for %s, folder: %s")
#define ERR_IMAPMNT_DISABLED				PKG_NSF_STR2+18
	stringtext(ERR_IMAPMNT_DISABLED,		"Disabled")
#define ERR_IMAPMNT_ENABLED					PKG_NSF_STR2+19
	stringtext(ERR_IMAPMNT_ENABLED,			"Enabled")

// string resource for imapmt utility
#define ERR_IMAPMNT_PROCESSING_T			PKG_NSF_STR2+20
	stringtext(ERR_IMAPMNT_PROCESSING_T, "IMAP Maint - Processing database: %1$p (%2$s), %3$s, %4$s\n")
#define ERR_IMAPMNT_NAMETABLE				PKG_NSF_STR2+21
	stringtext(ERR_IMAPMNT_NAMETABLE, "IMAP Maint - Database %p needs compact")

#define ERR_DL_PARSE							PKG_NSF_STR2+22
	stringtext(ERR_DL_PARSE, "Error parsing Deletion Logging item list for %1$p - %2$e\n")
#define ERR_COS_CERT_FILE_NOT_FOUND					PKG_NSF_STR2+23
	stringtext(ERR_COS_CERT_FILE_NOT_FOUND, "%1$s: Certificate file problem (use COS_CERTFILE notes.ini to point to certificate file): %2$s (%3$e)")

#define STR_DAOST2_FILE_NAME_TOO_LONG		PKG_NSF_STR2+24
	stringtext(STR_DAOST2_FILE_NAME_TOO_LONG, "ScanS3NLOThread: S3ListCallback - file name too long - '%.*s'\n")
#define STR_DAOST2_MISSING_DAOS_KEY			PKG_NSF_STR2+25
	stringtext(STR_DAOST2_MISSING_DAOS_KEY, "ScanS3NLOThread: S3ListCallback - malformed file name missing DAOS key - '%s'\n")
#define STR_DAOST2_INCORRECT_DAOS_LEN		PKG_NSF_STR2+26
	stringtext(STR_DAOST2_INCORRECT_DAOS_LEN, "ScanS3NLOThread: S3ListCallback - malformed file incorrect DAOS key length - '%s'\n")
#define STR_DAOST2_FAIL_CONVERT_VALUE		PKG_NSF_STR2+27
	stringtext(STR_DAOST2_FAIL_CONVERT_VALUE, "ScanS3NLOThread: DAOSConvertStringToBin failed processing value %s\n")
