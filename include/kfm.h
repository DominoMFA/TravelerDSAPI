...
#define fKFM_switchid_DontSetEnvVar			0x00000008
...
STATUS SECKFMClearCurrentIDFileForTryLoginAgainNFL(void); // NFL
...
#define SEC_extractattach_UserName	0x00000001
#define SEC_extractattach_SkipSync	0x00000002
...
STATUS LNPUBLIC SECRefreshIdFile (char	*pIDFileName, 
								  ...
								  DWORD Reserved,
							   	  void	 *pReserved);
STATUS LNPUBLIC NSFDB2GetUsernamePW	(char *pServerName, 
									 char *pFilename, 
									 KFM_PASSWORD *pKfmPW, 
									 char *retUserName, 
									 char *retPassword);

STATUS LNPUBLIC NSFDB2PutUsernamePW (char *pServerName, 
									 char *pFilename, 
									 char *UserName, 
									 char *Password, 
									 KFM_PASSWORD *pKfmPW);

STATUS LNPUBLIC NSFDB2DeleteUsernamePW (char *pServerName, 
										char *pFilename, 
										KFM_PASSWORD *pKfmPW);
