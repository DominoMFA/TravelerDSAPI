...
#define ERR_TITLE					PKG_SERVER+55
	stringtext(ERR_TITLE,			"IBM Domino Server")
...
#define ERR_SL_TITLE				PKG_SERVER2+36
	stringtext(ERR_SL_TITLE,		"IBM Notes SL")
#define ERR_SL_ERROR				PKG_SERVER2+37
	stringtext(ERR_SL_ERROR,		"IBM Notes SL Error")
...
#define STR_LUM_NO_PROD_LIC				PKG_SERVER6+37
	stringtext(STR_LUM_NO_PROD_LIC,		"IBM Domino does not have a production license.  A temporary evaluation license has been enrolled for you to use for 90 days.")
#define STR_LUM_EXP_LIC					PKG_SERVER6+38
	stringtext(STR_LUM_EXP_LIC,			"Your license is expired. You should install a production version of IBM Domino to continue using this product.")
...
/* We are out of strings, so using part of shutdown mon task string for QoS task string */
#define ERR_SERVER_SHUTDOWN_MON_TASK		PKG_SERVER7+64
	stringtext(ERR_SERVER_SHUTDOWN_MON_TASK	,"Shutdown Monitor|QoS Task")
