...
#define ERR_DBD_STRUCT_IS_INVALID			PKG_DBD+126
	errortext(ERR_DBD_STRUCT_IS_INVALID, "<Database Access > DBD internal memory structure for database is Invalid!")

#define ERR_DBD_STRUCT_IS_NULL			PKG_DBD+127
	errortext(ERR_DBD_STRUCT_IS_NULL, "<Database Access > DBD internal memory structure for database is NULL!")
...
#define ERR_DBD_CANT_GET_SERVER_NABS	PKG_DBD+181
	errortext(ERR_DBD_CANT_GET_SERVER_NABS, "DBD cannot get the list of address books for the local server.")
