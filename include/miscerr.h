...
#define ERR_FOLDER_OLDSERVER			PKG_MISC+88
	errortext(ERR_FOLDER_OLDSERVER,		"Sorry, this database is on a server running a previous version of IBM Notes that does not support folders.")
...
#define ERR_NEWVIEWTYPE_OLDSERVER		(PKG_MISC+156)
	errortext(ERR_NEWVIEWTYPE_OLDSERVER,"This database is on a server running a previous version of IBM Domino that does not support this type of view or folder.")
...
#define	ADMIN_FAULT_REPORTS_TITLE			PKG_MISC_STR+44
	stringtext(ADMIN_FAULT_REPORTS_TITLE,		"IBM Notes/Domino Fault Reports")
...
#define	STR_MISC_SU_TRACKING_TITLE			PKG_MISC_STR+55
	stringtext(STR_MISC_SU_TRACKING_TITLE,	"IBM Notes/Domino Smart Upgrade Tracking Reports - %s")
...
#define STR_CMD_CERTMGMT_IMPORT			PKG_MISC_STR+86
	stringtext(STR_CMD_CERTMGMT_IMPORT,	"IMPORT        [overwrite] [pkcs12 | xml] filename [filePw]")
#define	STR_HELP_CERTMGMT_IMPORT		PKG_MISC_STR+87
	stringtext(STR_HELP_CERTMGMT_IMPORT,"Import certificates from file to current id file or to directory")
#define STR_CMD_CERTMGMT_EXPORT			PKG_MISC_STR+88
	stringtext(STR_CMD_CERTMGMT_EXPORT,	"EXPORT   saml [overwrite] [pkcs12 | xml] filename [filePw]")
...
#define STR_CMD_CERTMGMT_CREATE			PKG_MISC_STR+90
	stringtext(STR_CMD_CERTMGMT_CREATE,	"CREATE   saml [overwrite]")
...
#else
	stringtext(STR_CMD_CERTMGMT_REGISTER,	"REGISTER [overwrite] [xml] filename")
#endif
...
/* PKG_MISC_STR goes to 255 ,  115-225 are available*/
