...
/*                                                                   */
/* Copyright IBM Corp. 1995, 2013  All Rights Reserved.              */
/*                                                                   */
...
#define ERR_QUERY_UNKNOWNTERM	PKG_AGENTS+3
	errortext(ERR_QUERY_UNKNOWNTERM,	"This search cannot be recognized by this version of IBM Notes.")
#define ERR_ACTION_UNKNOWNTERM	PKG_AGENTS+4
	errortext(ERR_ACTION_UNKNOWNTERM,	"This action cannot be recognized by this version of IBM Notes.")
...
#define ERR_ACCESS_OLDVERSION		(PKG_AGENTS+83)
	errortext(ERR_ACCESS_OLDVERSION,	"The server is running a previous version of IBM Notes that does not support private agents")
...
#define ERR_AGENT_SEC_CONFIGURATION   (PKG_AGENTS2+3)
	errortext(ERR_AGENT_SEC_CONFIGURATION, "Error in agent security configuration. Please contact your administrator.  Server log contains additional details.")
...
#define ERR_AGENT_FT_CANTRUN				(PKG_AGENTS3+7)
	stringtext(ERR_AGENT_FT_CANTRUN,		"Agent cannot run. Database is not full text indexed and INI variable FT_FLY_INDEX_OFF is set.")
...
#define ERR_AGENT_WRONGVERSION_GENERIC		(PKG_AGENTS3+13)
	errortext(ERR_AGENT_WRONGVERSION_GENERIC,"This version of IBM Notes does not support agents of this version")
...
#define ERR_AGENT_OOO_SERVER_RIGHTS		(PKG_AGENTS3+46)
	errortext(ERR_AGENT_OOO_SERVER_RIGHTS,		"Server '%a' does not have rights to sign 'Out of office' agent on server '%a'. Please add '%a' to 'Sign agents to run on behalf of someone else' field in Programmability Section of Domino Directory")			
#define ERR_AGENT_OOO_SIGNER_RIGHTS		(PKG_AGENTS3+47)
	errortext(ERR_AGENT_OOO_SIGNER_RIGHTS,		"'Out of office' agent for user '%a' is signed by '%a' who is not listed in 'Sign agents to run on behalf of someone else' field in Programmability Section of Domino Directory. Please validate the agent and sign it with an id that has this right")
/* extended codes to AGENTS3 PKG limited to strings PKG_AGENTS3+0 through PKG_AGENTS3+47 */
#endif
