...
#define NOTE_CLASS_NONPRIV			0x0FFF      /* turn off the unthinkable bits and NOTE_CLASS_PRIVATE */
	
								                /* for turning off the unthinkable bits and  NOTE_CLASS_REPLFORMULA */
#define NOTE_CLASS_REPLINIT                     (NOTE_CLASS_REPLFORMULA | NOTE_CLASS_IMAP | NOTE_CLASS_DoNotUse_ItsRuss)
...
#define NTEXT_IGNORE_LZ1	0x0200	/*	Ignore LZ1 decompress error and save data anyway */
...
#define	GETNOTES_FORCE_STREAMING	0x00000080	/* Force streaming, WARNING: only to be used for testing purposes */
...
STATUS LNPUBLIC NSFNoteOpenByUNIDExtended(DBHANDLE hDB, UNID far *pUNID, DWORD OpenFlags, NOTEHANDLE far *rethNote);
...
STATUS LNPUBLIC NSFProfileSetFieldExt(
		DBHANDLE hDB, const char *ProfileName, WORD ProfileNameLength,
		const char *UserName, WORD UserNameLength,
		const char *FieldName, WORD FieldNameLength,
		WORD Datatype, void *Value, DWORD ValueLength, DWORD dwOptions);
