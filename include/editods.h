...
#define STYLE_FLAG_MARGIN   	0x00000008L
typedef struct
	{
	BSIG Header;
...
#define FL_PICTURE			0
#define FL_SHAREDIMAGE		1
#define FL_ATTACHMENT		2
#define FL_EMBEDDEDVIEW		3
#define FL_DATEPICKER		4
#define FL_SHAREDAPPLET		5
#define FL_TEXTONLY			6
#define FL_OLEOBJECT		7
#define FL_CALENDAR			8
#define FL_INBOX			9
#define FL_GRAPHIC			12
#define FL_LINK				14
#define FL_THUMBNAIL		15
...
#define FEXT_USEJSCTLINBROWSER		0x04000000 /* TRUE if we should use a JS Control in the browser */
#define FIELD_LIMIT_TYPE_PICTURE		0x00000001
#define FIELD_LIMIT_TYPE_APPLET			0x00000002
#define FIELD_LIMIT_TYPE_SHAREDIMAGE 	0x00000004
#define FIELD_LIMIT_TYPE_OBJECT			0x00000008
#define FIELD_LIMIT_TYPE_TEXTONLY		0x00000010
#define FIELD_LIMIT_TYPE_VIEW			0x00000020
#define FIELD_LIMIT_TYPE_CALENDAR		0x00000040
#define FIELD_LIMIT_TYPE_INBOX			0x00000080
#define FIELD_LIMIT_TYPE_ATTACHMENT		0x00000100
#define FIELD_LIMIT_TYPE_DATEPICKER		0x00000200
#define FIELD_LIMIT_TYPE_GRAPHIC		0x00000400
#define FIELD_LIMIT_TYPE_HELP			0x00000800
#define FIELD_LIMIT_TYPE_CLEAR			0x00001000
#define FIELD_LIMIT_TYPE_LINK			0x00020000
#define FIELD_LIMIT_TYPE_THUMBNAIL		0x00040000
...
#define EMBEDDEDOUTLINE_FLAG_USEJSCTLINBROWSER		0x02000000
#define EMBEDDEDOUTLINE_FLAG_USECUSTOMJSINBROWSER	0x04000000
...
#define EMBEDDEDVIEW_FLAG_USEJSCTL_INBROWSER			0x4000	/* use dojo control in browser */
#define EMBEDDEDVIEW_FLAG_USECUSTOMJS_INBROWSER			0x8000	/* use custom JS in browser */
