...
#define ERR_SERVER_NOT_FOUND			PKG_CLIENT+3
	...
	errortext(ERR_SERVER_NOT_FOUND,		"Unable to find path to server. To trace this connection, use IBM Notes - Preferences - User Preferences - Ports - Trace (Notes client) or Trace command (Domino server)")
#endif
