...
#define FIND_AND_READ_MATCHES	0x2000	/* Read and buffer matches NIFFindByKeyExtended2 only */
...
STATUS LNPUBLIC		NIFFindByKeyExtended2 (HCOLLECTION hCollection, void far *KeyBuffer,
									DWORD FindFlags,
									DWORD ReturnFlags,
