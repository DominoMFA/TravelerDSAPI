...
#define MINSIZEFORDOCTRUNCATION		40960	//40k
...
#define SECS_IN_HOUR 3600		/* seconds in a hour */
...
#define DT_SHOWABBREV	0x0800		/* Displays the date as an abbriviated date */
...
STATUS LNPUBLIC SECHashPassword3(WORD	wPasswordLen,
							   BYTE		*Password,
							   WORD		wVersion, 
							   WORD		wHashType,
							   BYTE		*Param1, 
...
#define SEC_pwddigest_V1		1	/* Compatible with 4.5+						*/ 
#define SEC_pwddigest_V2		2	/* More secure, compatible with R4.6+		*/
#define SEC_pwddigest_V3		3	/* Even more secure compatible with 8.01+	*/
...
/* clientinfo.c */
STATUS FAR PASCAL ClientSetCapabilities(DWORD dwCapMask, DWORD dwCapabilities);
DWORD FAR PASCAL ClientGetCapabilities(void);
BOOL FAR PASCAL ClientHasCapability(DWORD dwCapability);
