...
#define STR_RQST3_LIST								(PKG_NETWORK+241)
	stringtext(STR_RQST3_LIST,	"FINDDESIGN_NOTES|GET_DBINFO|DB_GETSET_DEL_SEQNUM|NAME_LOOKUP32|COPY_FILE|GET_DBINFO|GET_OBJECT_INFO_EXT2|COPY_FILE_FROM_SERVER|REPAIR FILE|SAAS_READ_FILE|SAAS_WRITE_FILE")
...
#define IDX_STR_SAAS_READ_FILE			10
#define IDX_STR_SAAS_WRITE_EXT			11
