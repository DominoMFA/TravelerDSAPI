...
#define ERR_FAULT_RECOVERY_CRASHREPORTER		PKG_OS+22
	errortext(ERR_FAULT_RECOVERY_CRASHREPORTER,	"The CrashReporter will generate the crash log after you close this dialog. If you are going to send a bug report to IBM, be sure to include the CrashReporter log.")
#if defined(NT)
