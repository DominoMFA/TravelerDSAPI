...
#define LOG_FT_STRINGS1				PKG_FT+63
	errortext(LOG_FT_STRINGS1, "FT KV Text Filter error processing %p - %s|Removing full-text index directory %s")
#define LOG_FT_KEYVIEW_ERR_FS	1
#define LOG_FT_DELETE_INDEX		2
