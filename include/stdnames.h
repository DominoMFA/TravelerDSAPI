...
#define FIELD_ON_BEHALF_OF "$OnBehalfOf"	/* to prevent spoofing cases wherein $UpdatedBy contains server name, true authenticated user goes here */
...
#define XPAGE_ALTERNATE			"$XPageAlt"			/* override this design element with this xpage */
#define XPAGE_ALTERNATE_CLIENT	"$XPageAltClient"	/* override this design element with this xpage on the client */
...
#define FIELD_CRITICAL_VIEW 			"$CriticalView"	/* NIF will treat this views as critical and mark DB accordingly if view is unavailable */
#define	FIELD_CRITICAL_VIEW_ENABLED		'1'

#define FIELD_DLITEMS	"$DLItems"		/* list of items to include in the deletion log for deleted notes */
...
#define ITEM_MODIFIEDTIME	"$$ModifiedTime"	/* TIMEDATE this entry was last modified in the file. 
												   This the modifed in this file time for NSF backed directories. */
...
#define ITEM_DIRENTRYID		"$$DirEntryID"		/* Unique identifier of a directory entry, returned
												 * from NAMELookup.  Good for Domino or LDAP backends.*/								 
#define ITEM_DIRDOMAIN		"$$Domain"			/* Name of the directory domain (not mailDomian) the entry
												   resides in, typically defined in directory assistance */
#define ITEM_DOMAINTITLE		"$$DomainTitle"		/* Title of directory domain suitable for user presentation */

#define ITEM_DIRSERVER		"$$DirServer"		/* The name of the server specified in the DIRCTX of a search or get */

#define ITEM_DIRHENTRY		"$$hEntry"			/* The handle of the Entry */

#define ITEM_INDENTLEVEL 	"$$IndentLevel"		/* Indent level for view based information */

#define ITEM_INDEXCHILDREN 	"$$IndexChildren"	/* Index children for view based information */
#define ITEM_VLVLASTFIRSTM	"$$VLVLastFirstM"		/* VLV Index item used for people view displays */
#define ITEM_CERTEXP		"$$CertificateExpiration"	/* Certificate Expiration Date to be used for people view display */
#define ITEM_CERTISSUER		"$$CertificateIssuer"		/* Certificate Issuer to be used for people view display */
#define ITEM_EXTATTR		"$$ExtAttr"			/* Container attribute for non-schema attributes */


#define ITEM_DOMAINPATH		ITEM_DBNAME
...
#define NAMEDNOTE_DELETION_LIST	"$DeletionList"
...
#define NAMEDNOTE_REMOTEIMAGEPROFILE	"remoteimageprofile"
...
#define AUTO_POPULATE_MEMBER_INTERVAL		"AutoPopulateMembersInterval"
#define AUTO_POPULATE_CONFIG_INTERVAL		"AutoPopulateConfigInterval"
#define DIRECTORY_PROTECTED_GROUPS			"ProtectedGroups"
...
#define DESIGNER_MIN_VERSION_8_5	"8.5"
#define DESIGNER_MIN_VERSION_8_5_3	"8.5.3"
#define DESIGNER_MIN_VERSION_8_5_4	"8.5.4"
#define DESIGNER_MIN_VERSION_9		"9"
#define DESIGNER_MIN_VERSION_10		"A"

#define XSP_CLASS_INDEX				"$ClassIndexItem"
...
#define DESIGN_FLAG_PROPFILE			'2' /* xpage/cc properties file */
...
#define DESIGN_FLAG_STYLEKIT			'`'	/* style kit design element */
#define DESIGN_FLAG_WIDGET				'_' /* also has a g and is a file, but a component/widget design element */
...
#define DESIGN_FLAGS_SUBCLASS		"UW#yi@GFXstmzk=K;g%[]{^,"
...
#define DFLAGPAT_VIEWFORM "-FQMUGXWy#i:|@0nK;g~%z^"	/* display things editable with dialog box; version filtering */
#define DFLAGPAT_VIEWFORM_MENUABLE "-FQMUGXWy#i:|@40nK;g~%z^}"	/* display things showable on the menu */
#define DFLAGPAT_VIEWFORM_ALL_VERSIONS "-FQMUGXWy#i:|@K;g~%z^}" /* display things editable with dialog box; no version filtering (for design) */

#define DFLAGPAT_FORM "-FQMUGXWy#i:|@0nK;g~%z^"	/* display things editable with dialog box; version filtering */
#define DFLAGPAT_FORM_OR_SIMILAR "-FMGXy#i=:|@0K;g~%z^"	/* Form, page or subform design element, visible to client and web */
#define DFLAGPAT_FORM_OR_PAGE "-FQMUGXy#i:|@0nK;g~%z^"	/* Form or page design element */
#define DFLAGPAT_FORM_MENUABLE "-FQMUGXWy#i:|@40nK;g~%z^}"	/* display things showable on the menu */
#define DFLAGPAT_FORM_ALL_VERSIONS "-FQMUGXWy#i:|@K;g~%z^}" /* display things editable with dialog box; no version filtering (for design) */
#define DFLAGPAT_PRINTFORM_ALL_VERSIONS "+?" /* display things editable with dialog box; no version filtering (for design) */
#define DFLAGPAT_FIELD "-FQMUGXWy#i@0nK;g~%z^"	/* display things editable with dialog box; version filtering (more complex than necessary,
													but trying to avoid any possible incompatibility vs. earlier use of DFLAGPAT_VIEWFORM) */
#define DFLAGPAT_FIELD_ALL_VERSIONS "-FQMUGXWy#i@K;g~%z^}" /* display things editable with dialog box; no version filtering (for design) */
...
#define DFLAGPAT_QUERYBYFORM "-DU40gnyz{:|"	/* display forms that appear in query by form; version filtering */
...
#define DFLAGPAT_VIEW_MENUABLE "-FQMUGXWy#i@40nK;g~%z^}"	/* display things showable on the menu */
...
#define DFLAGPAT_JAVAFILE		"(+-*g["	/* display only java design elements */
...
#define DFLAGPAT_XSPPAGE		"*gK"		/* xsp pages */
#define DFLAGPAT_XSPPAGE_WEB	"(+-w*gK"	/* xsp pages for the web */
#define DFLAGPAT_XSPPAGE_NOTES	"(+-n*gK"	/* xsp pages for Notes */

#define DFLAGPAT_XSPPAGE_NOPROPS		"(+-2*gK"		/* xsp pages, no prop files */
#define DFLAGPAT_XSPPAGE_NOPROPS_WEB	"(+-2w*gK"	/* xsp pages, no prop files, for the web */
#define DFLAGPAT_XSPPAGE_NOPROPS_NOTES	"(+-2n*gK"	/* xsp pages, no prop files, for Notes */

#define DFLAGPAT_XSPCC			"*g;"		/* xsp pages */
#define DFLAGPAT_XSPCC_WEB		"(+-w*g;"	/* xsp pages for the web */
#define DFLAGPAT_XSPCC_NOTES	"(+-n*g;"	/* xsp pages for Notes */
...
#define DFLAGPAT_FILE			"+g-K[];`,"		/* display only files */
#define DFLAGPAT_FILE_DL		"(+g-~K[];`,*"	/* list of files that should show in file DL */
#define DFLAGPAT_FILE_NOTES		"(+g-K[];n`,*"	/* list of notes only files */
#define DFLAGPAT_FILE_WEB		"(+g-K[];w`,*"	/* list of web only files */
...
#define DFLAGPAT_FILE_ELEMS		"(+gi|=-/[],*"	/* files plus images plus comp app plus style sheets with no directory elements, java elements */
...
#define DFLAGPAT_STYLEKIT		"(+-*g`"	/* display only stylekits */
#define DFLAGPAT_STYLEKIT_NOTES "(+-n*g`"	/* display only notes client stylekits */
#define DFLAGPAT_STYLEKIT_WEB	"(+-w*g`"	/* display only web client stylekits */

#define DFLAGPAT_WIDGET			"(+-*g_"	/* display only widgets */
#define DFLAGPAT_WIDGET_NOTES	"(+-n*g_"	/* display only notes client stylekits */
#define DFLAGPAT_WIDGET_WEB		"(+-w*g_"	/* display only web client stylekits */
...
#define DESIGN_FLAGEXT_JAVA_ERROR               'E' /* for Java script libs and agents, indicates if it has errors */
#define DESIGN_FLAGEXT_WEBSERVICELIB			'W' /* 	Scriptlib is a web service consumer lib*/
#define DESIGN_FLAGEXT_WEBCONTENTFILE			'w' /* for files, indicates it's in the web content directory */
#define DESIGN_FLAGEXT_REBUILD_VIEW				'X' /* After initial creation of a replica, these view are rebuilt */
#define DESIGN_FLAGEXT_VOLT				'V' /* for design elements created by HCL Volt vs by the user */
...
/* Default Mail font style*/
#define DEFAULT_STYLE_MAIL   "DefaultStyleForMail"
...
#define MAIL_PARTIALSENT_ITEM "PartialSent"		/* Partial Sent item name */
...
#define MAIL_EXCLUDEFROMVIEW_ITEM	"ExcludeFromView"	/* View(s) to exclude note from in mail file.  Encoded values are MAIL_VIEWEXCLUDE_NAME_... */
...
#define MAIL_TMP_MSG_ID_INC_SECS "tmpMsgIdIncSecs"				/* If on the note during mailing, use this to enforce uniqueness in MAIL_ID_ITEM (then delete) */
...
#define MAIL_SENTAFTER_ITEM "$SentAt"		/* Scheduled mail date and time specified when released */
...
/*	The following constant and its corresponding _CHAR constant below are not
	settable from the UI but are still used internally in code and can be set
	programmatically based on Encryption Capabilities ($CryptoCap).
*/
#define IMSG_PREFERENCE_MIME_IFENCRYPTINGANDNOLOSS	4   /* Convert to SMIME on encryption when conversion is not lossy*/

#define IMSG_PREFERENCE_FORMATS				5	/* Count of known preference formats */
#define IMSG_PREFERENCE_NOTES_CHAR				'0'	
#define IMSG_PREFERENCE_NOTES_AND_MIME_CHAR		'1'	
#define IMSG_PREFERENCE_MIME_CHAR				'2'	
#define IMSG_PREFERENCE_HAIKU_CHAR				'3'	
#define IMSG_PREFERENCE_MIME_IFENCRYPTINGANDNOLOSS_CHAR '4'  
...
#define IMSG_SMTP_DSN_MESSAGEID_ITEM		"SMTPSavedMsgID"		/* Message-ID for the embedded rfc822 message in a Delivery Status Report */
...
/* Most Calendar Profile settings have the same values for on/off so define a common
** value to use in code instead of having to define separate MAIL_CALENDAR_PROFILE_xxx_DISABLED
** and MAIL_CALENDAR_PROFILE_xxx_ENABLED values for each and every one.
** There are some settings that are multivalued like MAIL_CALENDAR_PROFILE_PREVENTREPLIESINBOX_ITEM
** so for those settings we should define setting specific values to check against.
*/

#define MAIL_CALENDAR_PROFILE_SETTING_DISABLED				'0'
#define MAIL_CALENDAR_PROFILE_SETTING_DISABLED_STR			"0"
#define MAIL_CALENDAR_PROFILE_SETTING_ENABLED				'1'
#define MAIL_CALENDAR_PROFILE_SETTING_ENABLED_STR			"1"
...
#define MAIL_CALENDAR_PROFILE_AUTOPROCESS_PROCESS_INFO_UPDATES	"AutoprocessUpdates"
#define MAIL_CALENDAR_PROFILE_AUTOPROCESS_PROCESS_INFO_UPDATES_OLD_TIME	"AutoprocessUpdatesIfOutdated"
/* The following 5 options are reserved for future use.  The template will leave autoprocessing bit ON if any of
 * these exist with a value of "1" - AutoProcessOpt1 - AutoProcessOpt5 */
#define MAIL_CALENDAR_PROFILE_AUTOPROCESS_PROCESS_OPT1		"AutoProcessOpt1"
#define MAIL_CALENDAR_PROFILE_AUTOPROCESS_PROCESS_OPT2		"AutoProcessOpt2"
#define MAIL_CALENDAR_PROFILE_AUTOPROCESS_PROCESS_OPT3		"AutoProcessOpt3"
#define MAIL_CALENDAR_PROFILE_AUTOPROCESS_PROCESS_OPT4		"AutoProcessOpt4"
#define MAIL_CALENDAR_PROFILE_AUTOPROCESS_PROCESS_OPT5		"AutoProcessOpt5"
...
#define MAIL_CALENDAR_PROFILE_DECLINEKEEPINFORMED_ITEM		"DeclineKeepInformed"
#define MAIL_CALENDAR_PROFILE_DELEGATEKEEPINFORMED_ITEM		"DelegateKeepInformed"
...
#define MAIL_CALENDAR_PROFILE_RETURN_RECEIPT_DEF_DISABLE    "rrDefaultDisable"
...
#define MAIL_CS_ST_ROOMNAME                        "STRoomName"
#define MAIL_CS_ST_CONFID                          "STUnyteConferenceID"
#define MAIL_CS_ST_UNYTECONFURL                    "STUnyteConferenceURL"

#define MAIL_CS_ST_TYPE_ITEM                       "SametimeType"
// Values that correspond to SametimeType
#define MAIL_CS_ST_TYPE_STCLASSIC                  '0'
#define MAIL_CS_ST_TYPE_LOTUSLIVE                  '1'
#define MAIL_CS_ST_TYPE_SAMETIME                   '2'
#define MAIL_CS_ST_TYPE_OTHER                      '9'

#define MAIL_CS_ST_SERVICEINFO                     "STServiceInfo"
// Values that correspond to STServiceInfo
#define MAIL_CS_ST_SERVICEINFO_STCLASSIC           "2"
#define MAIL_CS_ST_SERVICEINFO_LOTUSLIVE           "3"
#define MAIL_CS_ST_SERVICEINFO_SAMETIME            "1"
#define MAIL_CS_ST_SERVICEINFO_OTHER               "9"
...
#define MAIL_CS_NOTICETYPE_REPAIRED_ITEM "NoticeTypeRepaired" /* Notice type before document was repaired */
...
#define MAIL_CS_RNRVERSION_ITEM			"$RnRVersion"		
...
#define MAIL_CS_INETCHAIR_ITEM			"$InetChair"
...
#define MAIL_CS_APPTUNID_LOGICAL_ITEM	"ApptUNIDLogical"
...
#define MAIL_CS_NEWINSTANCEDATES_ITEM	"NewInstanceDates"
...
#define MAIL_CS_NEWENDDATETIME_ITEM		"NewEndDateTime"
...
#define MAIL_CS_IGNOREBROADCAST_ITEM	"IgnoreBroadcast"		/* Used by V11+ clients to override MAIL_CS_BROADCAST_ITEM on meetings greater than 24 hours: if NOT enabled, the entry IS a broadcast */
#define MAIL_CS_DUEDATE_ITEM			"DueDate"
#define MAIL_CS_FLAGS_ITEM				"$CSFlags"
#define MAIL_CS_FLAGS_REPAIRED_ITEM		"$CSFlagsRepaired"
#define MAIL_CS_FLAGS2_ITEM				"$CSFlags2"
...
#define MAIL_CS_NEW_ALTREQUIRED_ITEM	"AltNewRequiredNames"
#define MAIL_CS_ALTOPTIONAL_ITEM		"AltOptionalNames"
#define MAIL_CS_NEW_ALTOPTIONAL_ITEM	"AltNewOptionalNames"
#define MAIL_CS_ALTFYI_ITEM				"AltFYINames"
#define MAIL_CS_ALTDELEGATETO_ITEM		"AltDelegeeName"
#define MAIL_CS_INET_DELEGEE			"$InetDelegee"
...
#define MAIL_CS_COMMENTSDOC_ITEM		"CommentsDoc"  /* Flag item to indicate comments are on the notice (used in conjunction with StatusUpdate) */
#define MAIL_CS_FORMTOUSE_ITEM			"FormToUse"		/* Item added to outgoing C&S notices when core C&S code sends notices containing comments see mailmisc\csinit.cpp CCSEventDesc::InitOutgoingNotice for usage */
#define MAIL_CS_DOCUMENTTYPE_ITEM		"DocumentType"	/* Item added to outgoing C&S notices when core C&S code sends notices containing comments see mailmisc\csinit.cpp CCSEventDesc::InitOutgoingNotice for usage */
#define MAIL_CS_STATUS_UPDATE           "StatusUpdate" /* contains comment for accept/decline/delegate with comment */
#define MAIL_CS_TMP_STATUS_UPDATE_ITEM	"tmpStatusUpdate" /* Added by the template when the core code needs to add comments to outgoing notice */
#define MAIL_CS_TMP_STATUS_REMOVE_ITEM	"tmpRemovedStatusUpdate" /* Added by the template when the core code needs to add comments to outgoing uninvite notice */
...
#define MAIL_CS_REQUIREDVERSION_ITEM	"$CSRequiredVersion"
...
#define MAIL_CS_INET_ORIGINAL_DELEGATOR "InetOriginalDelegator"
#define MAIL_CS_DELEGATETO_LIST			"DelegateToList"
#define MAIL_CS_SETTING_DISABLED		'0'			/* Generic C&S "Disabled" setting for item value checking */
#define MAIL_CS_SETTING_ENABLED  		'1'			/* Generic C&S "Enabled" setting for item value checking */
#define MAIL_CS_SETTING_DISABLED_STR	"0"			/* Generic C&S "Disabled" setting string for item value checking */
#define MAIL_CS_SETTING_ENABLED_STR		"1"			/* Generic C&S "Enabled" setting string for item value checking */
#define MAIL_CS_BAD_INCOMING_ITEM		"$CSBadIncomingDoc"	/* Used to tag a doc for aborting & discarding during Router / autoprocessing */
...
#define MAIL_CS_WATCHEDITEMSMODIFIED_ITEM	"$WIModified"	/* Tells us which watched items have been modified */
...
#define MAIL_CS_EXCLUDE_MINIVIEW_ITEM	"$ExcludeMiniView"	/* SPR FPAI8FUSX5:  If item exists and is set to one, notice will NOT appear in the miniview, regardless of value of $MiniView */

#define MAIL_CS_FROMPREFERREDLANG_ITEM	"$FromPreferredLanguage"

#define MAIL_CS_COPYINTO				"CopyInto"
#define MAIL_CS_DRAGANDDROP				"DragAndDrop"

#define MAIL_CS_WASKEEPPOSTED_ITEM 		"WasKeepPosted"			/* C&S API: Template item on original doc used to track if user wanted to be kept notified of updates */
#define MAIL_CS_RESPACTTAKEN_ITEM 		"RespActTaken"			/* C&S API: Template item on original doc used to track response action taken */
#define MAIL_CS_RESPACTTAKEN_ACCEPT			'1'
#define MAIL_CS_RESPACTTAKEN_DELEGATE		'2'
#define MAIL_CS_RESPACTTAKEN_DECLINE		'3'
#define MAIL_CS_RESPACTTAKEN_COUNTERACCEPT	'4'
#define MAIL_CS_RESPACTTAKEN_COUNTERDECLINE	'5'
#define MAIL_CS_RESPACTTAKEN_COUNTER		'6'
#define MAIL_CS_RESPACTTAKEN_TENTATIVE		'7'

/* Extended Counter Propose items and related values for extended counter propose feature (new in 9.02) */
#define MAIL_CS_ECP_ALLOWED_ITEM_LIST		"$ECPAllowedItems"	/* The list of item names the chair is allowing invitees to propose changs to */
#define MAIL_CS_ECP_AUTOPROCESS_ITEM_LIST	"$ECPAutoProcessItems"	/* List of item names.  An extended counter propose request which proposes changes to these items (or a subset of them) will be autoprocessed */
#define MAIL_CS_ECP_PROPOSED_ITEM_LIST		"$ECPItems"		/* The list of items the invitee is proposing to change */
#define MAIL_CS_ECP_STATUS					"$ECPStatus"	/* Indicates how the meeting chair processed an extended counter propose request */
#define MAIL_CS_ECP_STATUS_DECLINED			'0'				/* Value for $ECPStatus.  Indicates that the chair declined the request */
#define MAIL_CS_ECP_STATUS_ACCEPTED			'1'				/* Value for $ECPStatus.  Indicates that the chair accepted the request */
#define MAIL_CS_ECP_STATUS_PARTIAL_ACCEPTED	'2'				/* Value for $ECPStatus.  Indicates that the chair partially accepted the request */

#define	MAIL_CS_RNR_REQUEST_STATUS_ITEM	"RQStatus"			/* R7: R&R Request status item.  This item MUST be put on all R&R requests starting in R7 and
															** it should nearly always be 'T' unless you really know what you are doing!
															*/
...
#define RNR_NOTIFY_OWNER_DAYS			"NoticeDays"		/* R8.52: R&R room preference for days to notify owners of
															** pending requests.  Days are encoded using the CstrflagTest
															** format.
															*/
#define RNR_NOTIFY_OWNER_SUNDAY			'1'
#define RNR_NOTIFY_OWNER_MONDAY			'2'
#define RNR_NOTIFY_OWNER_TUESDAY		'3'
#define RNR_NOTIFY_OWNER_WEDNESDAY		'4'
#define RNR_NOTIFY_OWNER_THURSDAY		'5'
#define RNR_NOTIFY_OWNER_FRIDAY			'6'		
#define RNR_NOTIFY_OWNER_SATURDAY		'7'

#define RNR_NOTIFY_OWNER_COUNT			"NoticeCount"		/* R8.52: R&R room preference for number of additional notices
															** to send to owners.  When used on a reservation, it indicates the
															** number of notices already sent.
															** If this item does not exist then NotifyDate MUST also not exist.
															*/


#define RNR_NOTIFY_OWNER_DATE			"NotifyDate"		/* R8.52: R&R reservation item used to indicate the date (time component is
															** ignored!) when the last WFA notice was sent.  This is used to prevent
															** task restarts and cluster failovers from generating all the allowed WFA
															** notices in one day.
															** If this item does not exist then NotifyCount MUST also not exist.
															*/
...
/* Several of the following items were originally created in 7.0 for R&R so they were prefixed with
** RNR_.  As of 9.02 we are expanding Schedule Manager to have the same cluster failover ability.  
** Normally I would try to renaming some items to make them more descriptive of their use but I 
** cannot in this case.  It is not possible to reuse the same failover items in 9.02+ for Sched that are
** available in 7+ for RnRMgr.  Thats because it makes a pre-9.02 R&R server looks like a 9.02+
** Sched server which makes it impossible to differentiate which clustermates Sched can actually 
** perform failover for and which it cannot.  To avoid totally messing up busytime in a mixed
** pre-9.02 / 9.02+ cluster the only solution is to use the same mechanism but a totally separate form.
** It is not ideal when we get to a homogeneous 9.02+ deployment eventually but there is nothing we 
** can do in the short term to prevent busytime from getting less reliable instead of more reliable.
*/

#define RNR_SERVER_PROFILE_FORM			"ServerProfile"		/* R7: R&R Server Profile form name */
#define SCHED_SERVER_PROFILE_FORM		"BTServerProfile"	/* R9.02: Sched Server Profile form name */
...
** In D9.02 we are adding the cluster failover ability to Schedule Manager too.  That means
** some of the #define items need to be renamed.
** Since we are using different forms for Sched and RnRMgr we can share the same item names and values
** so I changed the prefix from RNR_ to SR_ and not some monstrosity like SCHED_AND_RNR_.
*/

#define SR_SERVER_FULLYINIT_ITEM		"FullyInitd"		/* R7(R&R)/R9.02(Sched+R&R) Server task fully initialized status */
#define SR_SERVER_FULLYINIT_YES			'Y'					/* R7(R&R)/R9.02(Sched+R&R) Server task is "fully initialized" */
#define SR_SERVER_FULLYINIT_NO			'N'					/* R7(R&R)/R9.02(Sched+R&R) Server task is NOT "fully initialized" */

#define SR_SERVER_TOOKCONTROL_ITEM		"TookControl"		/* TIMEDATE when R&R(R7+) or Sched(9.02+) server took control of a database */
#define SR_SERVER_RETURNCONTROL_ITEM	"ReturnControl"		/* TIMEDATE when R&R(R7+) or Sched(9.02+) server returned control 
															** to the Home Server.
															*/
...
#define MAIL_CS_ORGTABLE_CALENDAR_ENTRY			"C0"
#define MAIL_CS_ORGTABLE_TODO_ENTRY				"T0"
#define MAIL_CS_ORGTABLE_CALLS_ENTRY			"H0"
#define MAIL_CS_ORGTABLE_ALLDAYEVENT_ENTRY		"P0"
#define MAIL_CS_ORGTABLE_ADDRESS_ENTRY			"D0"
#define MAIL_CS_ORGTABLE_NOTEPAD_ENTRY			"N0"
#define MAIL_CS_ORGTABLE_ANNIVERARY_ENTRY		"A0"
...
#define MAIL_CS_REPEAT_COUNTERINSTANCEDATES_ITEM "CounterInstanceDates" /* new with Notes853 */
#define MAIL_CS_REPEAT_COUNTERSTARTDATETIMES_ITEM "CounterStartDateTimes" /* new with Notes853 */
#define MAIL_CS_REPEAT_COUNTERENDDATETIMES_ITEM  "CounterEndDateTimes" /* new with Notes853 */
...
#define MAIL_CS_ALARMON_ITEM				"h_AlarmOn"
...
#define MAIL_INOTES_PROFILE_FORM "iNotesProfile"	/*iNotes profile form name */
#define MAIL_INOTES_VIEW_PROFILE_FORM "iNotesViewProfile" /*iNotes view layout profile form name */
#define MAIL_DIRECTORY_PROFILE_FORM "DirectoryProfile"	/* Directory profile form name */
...
#define MAIL_INVITE_OTHERS_FORM "InviteeChanges"	/* C & S Form used when invitee performs Invite Others action.  Added for Invite Others feature, SPR DCAL5UAUUP */
...
#define MAIL_FEDCAL_PROFILE_FORM "FedCalProfile"
#define MAIL_FEDCAL_OTHER_PERSON_LIST "OtherPersonList"
#define MAIL_LAST_SELECTED_FOLDER_MV2FOLD "LastSavedFolderOfMoveToFolder"
#define MAIL_LAST_SELECTED_FOLDER_MV2FOLD_DESIGNTYPE "LastSavedFolderOfMoveToFolderDesignType"
#define MAIL_OWNER_CONTACT_PROFILE	"OwnerContact"  /* Contact profile form for generating owner vCard */
#define MAIL_OWNER_CONTACT_LONGFORM "$OwnerContactLongForm"
#define	MAIL_UNREFED_ATTACHMENTS_ITEM	"$UnrefedAttachments"
#define MAIL_OOS_RESPONSE_FORM		"(OOOServiceResponse)" /* OOO service response form */
#define MAIL_OOS_REPORT_FORM		"(OOOServiceReport)"   /* OOO service summary report form */

/* Out of office Service */
/* please keep fields in alphabetical order based on the actual field */
...
#define		OOOPROFILE_ADD_IGNORESUBJECTPHRASE			"Add_IgnoreSubjectPhrase"
#define		OOOPROFILE_ADMINPCOUNTER					"AdminP_Counter"
#define		OOOPROFILE_ADMINPSTATUS						"AdminP_Status"
#define		OOOPROFILE_ALTNOTIFICATION					"AlternateNotification"
#define		OOOPROFILE_APPEND_SUBJECT					"AppendSubject"
#define		OOOPROFILE_APPEND_SUBJECT_DATE				"AppendSubjectDate"
#define		OOOPROFILE_BOOKBUSYTIME						"BookBusyTime"
#define		OOOPROFILE_CALENDARENTRYUNID				"CalendarEntryUNID"
#define		OOOPROFILE_CLASSIFICATION					"Classification"
#define		OOPROFILE_TASKSTATUS_ITEM					"CurrentStatus"	 // enabled or disabled
...
#define		OOOPROFILE_DAYS_OUT_LINE_DISP_ITEM			"daysoutdisplay"
#define		OOOPROFILE_ENDTIME_ITEM						"EndTime"
#define		OOOPROFILE_EXCLUDE_INTERNET_ITEM			"ExcludeInternetEmail"
#define		OOOPROFILE_FIRSTDAYOUT_ITEM					"FirstDayOut"
#define		OOOPROFILE_FIRSTDAYBACK_ITEM				"FirstDayBack"
...
#define		OOOPROFILE_SHOWHOURS_ITEM					"ShowHours"
#define		OOOPROFILE_SPECIAL_BODY_ITEM				"SpecialBody"
...
#define		OOOPROFILE_STARTTIME_ITEM					"StartTime"	
#define		OOPROFILE_TASKTYPE_ITEM						"TaskType"		 // agent or service
#define		OOPROFILE_TASKSTATE_ITEM					"TaskState"		 // enabled, disabled, wait for adminp to enable, wait for adminp to disable
#define		OOOPROFILE_DEFINE_PDU						"UserDefineProhibitDesignUpdate"
#define		OOOPROFILE_SHOW_HOURS						"ShowHours"
#define		OOOPROFILE_DAYS_OUT_DISPLAY_ITEM			"DaysOutDisplay"
#define 	OOOPROFILE_ALTERNATE_DAYS_OUT_LINES_ITEM	"AlternateDaysOutLine"
#define 	OOOPROFILE_RETURN_DAY_SET_BY_OOOAPI			"ReturnDayForAlternateLine"
#define 	OOOPROFILE_RETURN_TIME_SET_BY_OOOAPI		"ReturnTimeForAlternateLine"

#define		OOS_PROCESSED_BY_OOS_ITEM					"$OOS"
#define		OOO_ENTRY									"$OOOEntry"		//	OOO entry in calendar (for busytime)
...
#define		OOS_RESP_TMPDAYSOUT_ITEM					"tmpDaysOut"
#define		OOS_RESP_TMPMESSAGE_ITEM					"tmpOOOMessage"
#define		OOS_RESP_TMPNOTIFYONCE_ITEM					"tmpNotifyOnce"
#define		OOS_REPORT_TMPNOTIFIEDNONE_ITEM				"tmpNotifiedNone"
#define		OOS_REPORT_TMPNOTIFYNAMES_ITEM				"tmpNotifyNames"
#define		OOS_REPORT_LANGSUBJECT_ITEM					"langSubject"
...
#define MAIL_MAIL_ITEM "Mail"					/* Mail item, LDAP equivalent to InternetAddress */
...
#define MAIL_COMPANYNAME_JA_ITEM "CompanyNameYomi"     /* Phonetic name for Company name - JA specific */
...
#define MAIL_PRIMARYADDRESS      "primaryAddress"
#define MAIL_UNMAPPEDDATA         "UnmappedData"

#define MAIL_OWNER_VCARD_FORM	"(VCardContact)"
#define MAIL_OWNER_VCARD_PATH   "VCardPath"         /* Path to temporary Owner vCard so that it can be attached by template */

#define MAIL_ITEM_LISTID "List-Id"				/* LIST-* Headers indicates if a message was auto-generated*/
#define MAIL_ITEM_LISTHELP "List-Help"
#define MAIL_ITEM_LISTSUBSCRIBE "List-Subscribe"
#define MAIL_ITEM_LISTUNSUBSCRIBE "List-Unsubscribe"
#define MAIL_ITEM_LISTPOST "List-Post"
#define MAIL_ITEM_LISTOWNER "List-Owner"
#define MAIL_ITEM_LISTARCHIVE "List-Archive"
...
#define MAIL_SHAREDUSERDICXML "UserDictionary"	/* xml of user dictionaries */
#define MAIL_UDIPERSISTXML "UDIPersist"	/* other xml file needed for dictionaries */
...
#define	KFM_FORM_VAULTTRUST_CERTIFICATE	"VaultTrustCertificate"
#define	KFM_FORM_PWDRESET_CERTIFICATE	"PasswordResetCertificate"
...
#define VAULTTRUSTCERTBYROOTNAMESSPACE	 "$CrossCertByRoot" 
#define	VAULTTRUST_NOTEID	 			 0
#define	VAULTTRUST_ISSUED_TO		 	 1
#define	VAULTTRUST_ISSUED_BY	 		 2
#define	VAULTTRUST_ITEM_CERTYPE		 	 3
#define	VAULTTRUST_ITEM_CERTNOENC	 	 4
#define	VAULTTRUST_LOOKUPITEMCOUNT	 	 5
#define VAULTTRUST_LOOKUPITEMS	 "$$NoteID\0IssuedBy\0IssuedTo\0CertificateType\0Certificate_NoEnc" 
#define VAULTTRUST_GETPUB_VIEWS		"($CrossCertByRoot)" 
#define VAULTTRUST_GETPUB_NUMVIEWS	1
...
*/
/* WARNING!!!  Do NOT change name of this value below to, for example, change Lotus to IBM.  This ID is the value
 * that has been used to sign ALL shipping templates.  Changing this value will break the product!  It should
 * NEVER be changed. */
#define NOTES_TEMPLATE_DEVELOPER_ID			"CN=Lotus Notes Template Development/O=Lotus Notes"
// A new template signing ID for 2048 bit keys
#define NOTES_TEMPLATE_SIGNING_ID			"CN=Domino Template Development/O=Domino"
/* WARNING!!! See above. */
...
// shared libraries and executables on a as needed basis across all supported platforms.
#define ND_NATIVECODE_DEVELOPER_ID	"CN=HCL Notes Domino Native Code Development/O=HCL Notes Domino"
...
#define NETAUTH_NAMESPACE_XCERTBYNAME		"($CrossCertByName)"
...
#define SEC_AUTH_ITEM_ROAMING_USER				35

#define SEC_AUTH_ITEMS_COUNT		 			36
...
#define ADMINP_DIR_ITEM_ENTRYID			 0
#define ADMINP_DIR_ITEM_DOMAIN			 1

#define	ADMINP_DIR_ITEM_CERTIFICATE	 	 2
#define	ADMINP_DIR_ITEM_CERT_NOENC		 3
#define ADMINP_DIR_ITEM_PUBLIC_KEY		 4
#define	ADMINP_DIR_ITEM_USER_CERT		 5
#define ADMINP_DIR_ITEM_CHANGE_REQUEST	 6

#define ADMINP_DIR_ITEMS_COUNT			 7
...
#define AdminpInitiateNABChange2Timed                    "193"
#define AdminpInitiateNABChange2TimedWord                193
#define AdminpInitiateWebNameChangeTimed         "194"
#define AdminpInitiateWebNameChangeTimedWord     194
...
/* Directory freedom NAB definitions	*/
#define DIRECTORYFREEDOM_FORMULA "Type!=\"Person\""
...
#define POLICY_DESKTOP_CONTACTDELEGATIONSWITCH		"ContactDelegationSwitch"
#define POLICY_DESKTOP_CONTACTDELEGATIONMAILREPID	"ContactDelegationMailRepID"
...
#define PERSON_PERSONALID                        "PersonalID"
...
#define MAIL_LISTCATEGORY_ITEM "ListCategory"            /* Distribution list category */
...
#define MAIL_LISTAUTOPOPULATE_ITEM "AutoPopulate"		/* This is an auto-populated group */
#define MAIL_LISTPARENT_ITEM "ParentGroup"		/* This group was automatically created from a parent group. */
#define MAIL_LISTSUBGROUP_ITEM "SubGroups"		/* This group has automatically created subgroups. */
#define MAIL_LISTAUTOPOPULATE_LAST_UPDATED_ITEM "$APLastUpdated"  /* Timestamp of when the group was last updated. */
#define	MAIL_LISTADDITIONALMEMBERS_ITEM "AdditionalMembers"	/* auto populate item */
#define	MAIL_LISTEXCLUDEDMEMBERS_ITEM "ExcludedMembers"	/* auto populate item */
...
#define MAIL_DPAB_IGNORE_PERSON_FORM "DPABIgnorePerson"		/* DPAB contact marked as ignore */
#define MAIL_DPAB_IGNORE_GROUP_FORM "DPABIgnoreGroup"		/* DPAB contact marked as ignore */

// CONTACT_ITEM_DPAB_STATE CAN BE UPTO 999
#define CONTACT_ITEM_DPAB_STATE "$DPABState"
#define DPAB_STATE_NORMAL 0
#define DPAB_STATE_NORMAL_STR "0"
#define DPAB_STATE_IGNORE_SYNC 20
#define DPAB_STATE_IGNORE_SYNC_STR "20"
#define DPAB_STATE_NO_SYNC 50
#define DPAB_STATE_NO_SYNC_STR "50"
#define DPAB_STATE_IGNORE_NO_SYNC 70
#define DPAB_STATE_IGNORE_NO_SYNC_STR "70"
...
#define REGISTER_GROUPSNAMESPACE_1 "1\\($RegisterGroups)"
#define REGISTER_GROUPS_LISTNAME_COLUMN	"$4"


/* Group type definitions */
#define GROUP_TYPE_MULTIPURPOSE			'0'
#define GROUP_TYPE_MULTIPURPOSE_VALUE	 0
#define GROUP_TYPE_MAILONLY				'1'
#define GROUP_TYPE_MAILONLY_VALUE		 1
#define GROUP_TYPE_ACCESSCONTROL		'2' 
#define GROUP_TYPE_ACCESSCONTROL_VALUE	 2	
#define GROUP_TYPE_DENYLIST				'3'
#define GROUP_TYPE_DENYLIST_VALUE		 3
#define GROUP_TYPE_SERVERONLY			'4'
#define GROUP_TYPE_SERVERONLY_VALUE		 4
...
#define ADMIN_PEOPLECAT_VIEW 		"PeopleCat"
...
#define ADMIN_CLUSTER_CONFIG		"ClusterConfigurations"
...
#define ADMIN_POLGROUP_VIEW			"($PoliciesByGroup)"
#define ADMIN_POLDYN_VIEW			"($PoliciesDynamic)"
#define ADMIN_POLDYNCAT_VIEW		"($PoliciesDynamicCat)"
...
#define ADMIN_ACCOUNTS_VIEW			"Accounts"
#define ADMIN_DIRSYNC_VIEW			"DirSync"
...
#define ADMIN_TRAVELER_CFG			"LotusTraveler.nsf"
...
/* FullText and Import Attachment prefixes  */
#define FULLTEXT_IMPORT_TEMP_FILE_PREFIX  "~ext"

/* Tika apache tmp file prefix */
#define TIKA_TEMP_FILE_PREFIX                   "apache-tika-"
...
#define AdminpIDVaultModify						"181"
#define AdminpSaaSPullMailfile					"182"  /* FAP added to aid in merge conflict resolution with fixes 217521, 214942, 218323 */
#define AdminpReplaceSaaSMailFileFields			"183"  /* FAP added to aid in merge conflict resolution with fixes 217521, 214942, 218323 */
#define AdminpDeletePersonInNABTimed			"184"  /* FAP added to aid in merge conflict resolution with fixes 217521, 214942, 218323 */
#define AdminpRenamePersonInCalendarFiles		"185"
#define AdminpRenameWebPersonInCalendarFiles	"186"
#define AdminpSetMicrosoftOutlookSupportFlag	"187"
#define AdminpUpdateSSLCipherSpecs				"188"
#define AdminpRenameCommonNameUserInNAB 			"189"
...
#define AdminpIDVaultModifyWord					181
#define AdminpSaaSPullMailfileWord				182 /* FAP added to aid in merge conflict resolution with fixes 217521, 214942, 218323 */
#define AdminpReplaceSaaSMailFileFieldsWord		183 /* FAP added to aid in merge conflict resolution with fixes 217521, 214942, 218323 */
#define AdminpDeletePersonInNABTimedWord		184 /* FAP added to aid in merge conflict resolution with fixes 217521, 214942, 218323 */
#define AdminpRenamePersonInCalendarFilesWord	185
#define AdminpRenameWebPersonInCalendarFilesWord 186
#define AdminpSetMicrosoftOutlookSupportFlagWord 187
#define AdminpUpdateSSLCipherSpecsWord			188
#define AdminpRenameCommonNameUserInNABWord		189
/* 190-196 used in SaaS 8.5.1 */

/*
** Need to declare the last adminp request so that buffers can be allocated
*/
#define	AdminpLastRequestNumber					189
/*
**
***/
...
#define ADMINP_RENAME_COMMON_NAME_VIEW			"Rename Common Name Requests"
...
#define	ADMINP_ROAMING_JOURNAL_NAME_ITEM		"ProxyRoamingJournal"
#define	ADMINP_ROAMING_BOOKMARK_NAME_ITEM		"ProxyRoamingBookmark"
#define	ADMINP_ROAMING_EXTENDED_FILES_ITEM		"ProxyRoamingExtFiles"
#define	ADMINP_ROAMING_STATE_CHANGE_ITEM		"ProxyRoamingStateChange"
#define ADMINP_ROAMING_MODE_ITEM				"ProxyRoamingMode"
#define ADMINP_ROAMING_FS_ACCESS_ITEM			"ProxyRoamingFSAccess"
...
#define ADMINP_ROAMING_BY_POLICY_ITEM			"ProxyRoamingByPolicy"
#define ADMINP_ROAMING_UPGRADE_ITEM				"ProxyRoamingUpgrade"
...
#define ADMINP_DOC_RETRACT_ENTRYID_ITEM			"ProxyRetractNameChangeEntryID"
#define ADMINP_DOC_RETRACT_DOMAIN_ITEM			"ProxyRetractNameChangeDomain"
...
#define ADMINP_DOC_DIRECTORY_DOMAIN_ITEM		"$ProxyDirectoryDomain"
#define ADMINP_DOC_DIRECTORY_NOTE_UNID_ITEM		"ProxyDirectoryNoteUNID"
#define ADMINP_DOC_DIRECTORY_ENTRYID_ITEM		"ProxyDirectoryEntryID"
...
#define ADMINP_NO_COMMON_NAME_ITEM				"ProxyNoCommonName"
...
#define ADMINP_DOC_VAULT_NAME					"ProxyIDVaultName"
#define ADMINP_IDVAULT_DELID					"ProxyIDVaultDelID"
#define ADMINP_IDVAULT_MARK_AS_INACTIVE			"0"
#define ADMINP_IDVAULT_DELETE					"1"
#define ADMINP_IDVAULT_RETAIN					"2"

/* Common Name change  */
#define ADMINP_DOC_NEW_COMMON_NAME_ITEM				"ProxyNewCommonName"
#define ADMINP_DOC_NEW_FULL_NAME_ITEM				"ProxyNewFullName"
#define ADMINP_DOC_NEW_LAST_NAME_ITEM				"ProxyNewLastName"
#define ADMINP_DOC_NEW_FIRST_NAME_ITEM				"ProxyNewFirstName"
#define ADMINP_DOC_NEW_MIDDLE_NAME_ITEM				"ProxyNewMiddleName"

/*
** Contact Delegation Items
** and "defines"
** at present only one flag indication.  When additional
** flags are defined, we should decide either to use a bit mask
** or numeric value as the indication.
*/
#define	ADMINP_ACTIVATE_CONTACT_DELEGATION_FLAG	1
#define ADMINP_PROXY_DELEGATE_FLAG_ITEM			"ProxyDelegateFlagsItem"
#define ADMINP_PROXY_DELEGATE_ROLE_LIST_ITEM	"ProxyDelegateRoleListItem"
#define ADMINP_PROXY_DELEGATE_ROLE_REMOVE_LIST_ITEM	"ProxyDelegateRoleRemoveListItem"
...
#define ADMINP_NUM_RETRIES_ITEM					"ProxyNumRetriesAlready"
...
#define	ADMINP_PROXY_BYPASS_DELETE_APPROVAL		"ProxyBypassDeleteApproval"		/* when enabled will indicate that no approval request should be generated */
...
#define ADMINP_NAB_PASS_CHANGE_DATE				"PasswordChangeDate"
#define ADMINP_NAB_PASS_DIGEST					"PasswordDigest"
...
#define ADMINP_NAB_OUTLOOK_SUPPORT						"bOutlookSupport"
...
/*
** mail file specific Privilege/Role Values
*/
#define ACCESS_CONTACTS				"[AccessContacts]"
/*
** Mail Directory Profile Specific Item
*/
#define	DIR_PROF_UPDATECONTACS_ITEM	"UpdateContacts"
#define DIR_PROF_FLAG_A_VALUE		"A"
...
#define	ROAMING_DB_LIST_ENTRIES			3			/* the number of entries for each roaming database definition */
													/* in adminp item ADMINP_ROAMING_DB_LIST */
...
/* localfeedcontent.nsf item definitions */
#define FEED_ITEM_TITLE		"item_title"
#define FEED_ITEM_DESCRIPTION	"item_description"
#define FEED_ITEM_FORM		"FeedItem"
#define FEED_ITEM_URL		"item_url"
#define FEED_ITEM_CATEGORY	"item_category"
...
#define ACCOUNT_DESCRIPTION		"AccountDesc"
#define ACCOUNT_PROPERTIES      "Properties"
...
/* new names related to account documents in standard client */
#define ACCOUNT_PROPERTIES_TYPE			"type"	
#define ACCOUNT_PROPERTIES_HIDEINUI		"hideinui"
#define ACCOUNT_PROPERTIES_AUTHTYPE		"authtype"
#define ACCOUNT_PROPERTIES_CREDID		"credentialid"
#define	ACCOUNT_PROPERTIES_AUTHSERVER   "authserver"
#define	ACCOUNT_PROPERTIES_SSOCREDID    "ssocredentialid"
#define	ACCOUNT_PROPERTIES_MASTER       "allowsharing"
#define ACCOUNT_PROPERTIES_MASTERPROPS	"masterprops"

#define ACCOUNT_PROPERTIES_ACCTTYPE	    "AccountType"	
#define ACCOUNT_PROPERTIES_ISPRIMARY    "isPrimaryAccount"
#define ACCOUNT_PROPERTIES_PRIMACTNAME  "primaryAccountName"
#define ACCOUNT_PROPERTIES_ISCSRFREQ    "IS_CSRFTOKEN_REQUIRED"
#define ACCOUNT_PROPERTIES_LLBSSID      "AccountService_ID"
#define ACCOUNT_PROPERTIES_ISSVRMNGD    "IS_SERVER_MANAGED"
#define ACCOUNT_PROPERTIES_ISCLOUDACT   "IS_CLOUD_ACCOUNT"
#define ACCOUNT_PROPERTIES_ISGLBACT     "IS_GLOBAL_ACCOUNT"
#define ACCOUNT_PROPERTIES_CSRFURL      "CSRF_Url"
#define ACCOUNT_PROPERTIES_EDITLST      "$EditableList"
#define ACCOUNT_PROPERTIES_PHOMEURL     "personalizedHome"
#define ACCOUNT_PROPERTIES_DOMINOSSO	"dominosso"
#define ACCOUNT_PROPERTIES_DOMINOSSOSRV	"dominossoserver"

//service provider property for supporting multiple data centers
#define ACCOUNT_PROPERTIES_SPNAME		            "AccountServiceProviderName" 


#define ACCOUNT_TYPEVAL_ST              "Sametime"


// st specific account fields
#define ACCOUNT_PROPERTIES_STPORT            "port"
#define ACCOUNT_PROPERTIES_STKPALIVE         "keepAliveInterval"
#define ACCOUNT_PROPERTIES_STICPATH          "iconPath"
#define ACCOUNT_PROPERTIES_STLGNSTRTUP       "loginAtStartup"
#define ACCOUNT_PROPERTIES_STUSETKN          "loginByToken"
#define ACCOUNT_PROPERTIES_STUSENOTESNAME    "readNotesCanonicalSetting"
#define ACCOUNT_PROPERTIES_STRSLVLIVNAME     "resolveLivenames"
#define ACCOUNT_PROPERTIES_STSVPSWD          "savePassword"
#define ACCOUNT_PROPERTIES_STSNDKPALIVE      "sendKeepAlive"
#define ACCOUNT_PROPERTIES_STUSEGLBSET       "useGlobalConnSettings"
#define ACCOUNT_PROPERTIES_STUSESRVRLKUP     "useServerForLookup"
#define ACCOUNT_PROPERTIES_STCNCTTYPE        "connectionType"
#define ACCOUNT_PROPERTIES_STPRXYTYPE        "proxyType"
#define ACCOUNT_PROPERTIES_STPRXYHOST        "proxyHost"
#define ACCOUNT_PROPERTIES_STPRXYPORT        "proxyPort"
#define ACCOUNT_PROPERTIES_STRSLVPRXYLOCL    "proxyResolvesLocally"
#define ACCOUNT_PROPERTIES_STTOKNHOSTURL     "tokenHostUrl"
#define ACCOUNT_PROPERTIES_STTRANSPORT       "transport"
#define ACCOUNT_PROPERTIES_STINTERNETFILTER  "InternetFilter"

#define ACCOUNT_TYPEVAL_CONN              "Connections"

// connections specific  account fields on the form
#define ACCOUNT_PROPERTIES_CONNDISPNAME    "ConnDispName"
#define ACCOUNT_PROPERTIES_CONNDISPEDITTAG "displaytag"

#define ACCOUNT_TYPEVAL_FLSHARE              "FileShare"
#define ACCOUNT_TYPEVAL_OTHER                "Other"

// new item added to account management profile to save file hash for EE
#define FIELD_SECUREFILE_ITEM                "$SecureFileData"
...
/* Journal view in Mail*/
#define MAIL_JOURNAL_VIEW		"($Journal)"

/* EML folder name*/
#define EML_FOLDER_NAME		"($EML)"
...
#define PERSON_ASSISTANT_PHONE          "PhoneNumber_8"
#define PERSON_OFFICE_PHONE2            "PhoneNumber_9"
#define PERSON_HOME_PHONE2              "PhoneNumber_10"
#define OTHER_FAX						"phone_6a"
#define PRIMARY_PHONE					"primaryPhoneNumber"
#define PERSON_BLOG_SITE				"Blogsite"
#define PERSON_ASSISTANT				"Assistant"
#define PERSON_DEFAULT_PHONE_LABELS     "defaultLabelList"
...
#define PERSON_ST_LOGIN					"SametimeLogin"
#define PERSON_BLOG_SITE				"Blogsite"
#define PERSON_OTHER_STREETADDRESS		"OtherStreetAddress"
#define PERSON_OTHER_CITY				"OtherCity"
#define PERSON_OTHER_STATE				"OtherState"
#define PERSON_OTHER_ZIP				"OtherZip"
#define PERSON_OTHER_COUNTRY			"OtherCountry"
#define PERSON_CUSTOM1					"Custom1"
#define PERSON_CUSTOM2					"Custom2"
#define PERSON_CUSTOM3					"Custom3"
#define PERSON_CUSTOM1_LABEL			"CLabel1"
#define PERSON_CUSTOM2_LABEL			"CLabel2"
#define PERSON_CUSTOM3_LABEL			"CLabel3"

#define PERSON_PREFERED_PHONE           "primaryPhoneNumber"
#define PERSON_PHONE_PREF_LABEL			"PrimaryPickP"
#define PERSON_PHONE_LABEL1             "DefaultLabel1"  /* Phone label for USERREG_OFFICEPHONE_ITEM  "OfficePhoneNumber"*/
#define PERSON_PHONE_LABEL2             "defaultLabel5"  /* Phone label for USERREG_PHONENUMBER_ITEM  "PhoneNumber"*/
#define PERSON_PHONE_LABEL3             "DefaultLabel3"  /* Phone label for USERREG_CELL_PHONE        "CellPhoneNumber"*/
#define PERSON_PHONE_LABEL4				"DefaultLabel2"  /* Phone label for USERREG_OFFICE_FAX        "OfficeFAXPhoneNumber"*/
#define PERSON_PHONE_LABEL5				"DefaultLabel4"  /* Phone label for USERREG_PAGER             "PhoneNumber_6"*/
#define PERSON_PHONE_LABEL6             "defaultLabel8"  /* Phone label for PERSON_ASSISTANT_PHONE    "PhoneNumber_8"*/
#define PERSON_PHONE_LABEL7				"defaultLabel6a" /* Phone label for USERREG_HOME_FAX          "HomeFAXPhoneNumber"*/
#define PERSON_PHONE_LABEL8				"defaultLabel7"  /* Phone label for PERSON_PERSONAL_PAGER     "PersPager"*/
#define PERSON_PHONE_LABEL9				"defaultLabel9"  /* Phone label for PERSON_OFFICE_PHONE2      "PhoneNumber_9"*/
#define PERSON_PHONE_LABEL10			"defaultLabel10" /* Phone label for PERSON_HOME_PHONE2        "PhoneNumber_10"*/
// associated PHONE dialog labels -- keep in  same order as phone PERSON_PHONE_LABELxxx
#define PERSON_PHONEDIALOG_LABEL1		"PhLabel_1"
#define PERSON_PHONEDIALOG_LABEL2		"PhLabel_5"
#define PERSON_PHONEDIALOG_LABEL3		"PhLabel_3"
#define PERSON_PHONEDIALOG_LABEL4		"PhLabel_2"
#define PERSON_PHONEDIALOG_LABEL5		"PhLabel_4"
#define PERSON_PHONEDIALOG_LABEL6		"PhLabel_8"
#define PERSON_PHONEDIALOG_LABEL7		"PhLabel_6a"
#define PERSON_PHONEDIALOG_LABEL8		"PhLabel_7"
#define PERSON_PHONEDIALOG_LABEL9		"PhLabel_9"
#define PERSON_PHONEDIALOG_LABEL10		"PhLabel_10"

#define PERSON_EMAIL_PREF				"PrimaryPick"    /* Prefered email address */
#define PERSON_EMAIL_LABEL1             "ELabel1"		 /* Email label for MAIL_EMAIL_1              "email_1"*/
#define PERSON_EMAIL_LABEL2             "ELabel2"		 /* Email label for MAIL_OTHER_EMAIL1         "MiscPhone1"*/
#define PERSON_EMAIL_LABEL3             "ELabel3"		 /* Email label for MAIL_OTHER_EMAIL2		  "MiscPhone2"*/
#define PERSON_EMAIL_LABEL4             "ELabel4"		 /* Email label for MAIL_OTHER_EMAIL3		  "MiscPhone3"*/
#define PERSON_EMAIL_LABEL5             "ELabel5"		 /* Email label for MAIL_EMAIL_5			  "email_5"*/
#define PERSON_ADDR_BUSS_LABEL			"BusinessLabel"
#define PERSON_ADDR_HOME_LABEL		    "PersonalLabel"
#define PERSON_ADDR_OTHER_LABEL			"OtherLabel"
#define PERSON_ADDR_PRIMARY_ADDRESS     "primaryAddress"  /*value matches users choice from person_addr_xxx_label*/
#define PERSON_DEFAULT_EMAIL_LABELS		"DefaultELabelList"

#define PERSON_NAME_FORMAT				"$NameFormat"
#define PERSON_ADDR_FORMAT				"$AddressFormat"
#define PERSON_ADDR_LABEL_FORMAT        "$BusinessAddressFormat"
#define PERSON_SAVED_UPDATE				"SavedUpdate"

#define PERSON_PHOTO					"photo"
#define PERSON_PHOTO_ATTACHMENT			"ContactPhoto"
...
/* Contact record Field Names */
#define OTHER_STREETADDRESS  		"OtherStreetAddress"
#define OTHER_CITY  				"OtherCity"
#define OTHER_STATE  				"OtherState"
#define OTHER_ZIP  				"OtherZip"
#define OTHER_COUNTRY  			"OtherCountry"
...
#define LDAP_GUID_VIEW		"($LDAPGUID)"
#define LDAP_DN_VIEW		"($LDAPDN)"
#define LDAP_CONTAINER_MAPPING_VIEW	"($LDAPCONTAINERMAPPING)"
...
#define LDAP_KRBUSERS_VIEW	"$KrbUsers"
...
#define DA_LDAPWRITEDN_ITEM				"LDAPWRITEDN"
#define DA_LDAPWRITEPASSWORD_ITEM		"LDAPWRITEPassword"
...
#define DAOS_CATALOG_DB					"daoscat.nsf"
#define INI_DAOS_ENABLED				"DAOSEnable"	//"1" OR "0"
#define INI_DAOS_MINOBJECTSIZE			"DAOSMinObjSize"
#define INI_DAOS_BASE_PATH				"DAOSBasePath"
#define INI_DAOS_DEFER_DEL_INTERVAL		"DAOSDeferredDeleteInterval"
#define INI_DEBUG_DAOS_COPY_OBJ			"DEBUG_DAOS_COPY_OBJ"
#define INI_DEBUG_DISABLE_DAOS_COPY_OBJ	"DEBUG_DISABLE_DAOS_COPY_OBJ"

#define INI_NIFNSF_ENABLED				"NIFNSFEnable"
#define INI_NIFNSF_BASE_PATH			"NIFBasePath"
#define INI_NIFNSF_CREATE_DATABASES		"CREATE_NIFNSF_DATABASES"


#define INI_CREATE_R10_DATABASES		    "Create_R10_Databases"
#define INI_CREATE_R9_DATABASES		    "Create_R9_Databases"
#define INI_CREATE_R85_DATABASES		"Create_R85_Databases"
#define INI_CREATE_R8_DATABASES			"Create_R8_Databases"
#define INI_CREATE_R6_DATABASES			"Create_R6_Databases"

/* ini variable to enable embedded experience in Notes code */
/* in V10, open social and embedded experiences is deprecated, 
   and features are removed from the install kit. 
   default value is changed to 0
 */
#define INI_ENABLEE "ENABLE_EE"       /* Set this to 1 to enable embedded experience */
#define	WIDGET_CATALOG_REQUIRED_ROLE	"[Admins]"

/* ini variable to control Notes Federated Login on client */
#define INI_ENABLNFL "EnableNotesFederatedLogin"       /* Set this to 0 to disable nfl */
/*ini variable to check Notes Client AUt is enabled*/
#define INI_ENABLEAUT "EnableNotesAUT"					/*Set this to 1 to enable AUT*/
...
#define INIT_DAOS_ENABLE				66
#define INIT_DAOS_MIN_OBJ_SIZE			67
#define INIT_DAOS_BASE_PATH				68
#define INIT_DAOS_DEFER_DELETE_INTERVAL 69

#define INIT_DAOS_T2_ENABLED			70
#define INIT_DAOS_T2_SERVER_ID			71
#define INIT_DAOS_T2_CRED_NAME			72
#define INIT_DAOS_T2_ENDPOINT			73
#define INIT_DAOS_T2_BUCKET				74
#define INIT_DAOS_T2_DAYS_TO_PUSH		75

#define INIT_DAOS_T2_REGION				76
#define INIT_DAOS_T2_PUSH_TIME_RANGE	77
#define INIT_DAOS_T2_INDEX_ATTACHMENTS	78

#define INIT_SERVERLOOKUPITEMCOUNT		79
...
#define FIELD_TOKENCOOKIENAME		"Ltpa_TokenCookieName"
#define FIELD_WSTOKENCOOKIENAME		"Ltpa_WSTokenCookieName"
#define FIELD_WSTOKEN2COOKIENAME	"Ltpa_WSToken2CookieName"
...
#define SCHED_USERLOOKUPITEMCOUNT			7
#define SCHED_USERLOOKUPITEMS "FullName\0ListName\0MailAddress\0MailDomain\0MailServer\0CalendarDomain\0$$DBName"
...
#define SCHED_USERLOOKUPDBNAMEITEM		6
...
#define SCHEDULE_MGR_LOOKUP_ITEM_COUNT			8
#define SCHEDULE_MGR_LOOKUP_ITEMS				"FullName\0MailServer\0MailFile\0MailDomain\0CalendarDomain\0Type\0MailAddress\0ResourceType"
...
#define SCHEDULE_MGR_LOOKUP_ITEM_RESOURCETYPE   7			/* For <MALE7G4RA9>, <MPUL75QD8Z> */
#define SCHEDULE_MGR_RESOURCE_MAILINDB          "0"			/* For <MALE7G4RA9>, <MPUL75QD8Z> */
...
#define VIEW_FOLDER_NUM_FOS			"$FolderNumFOs"			/* If present, highest # $FolderObject-# in note */
...
#define VIEW_BASE_VIEW_REFERENCE		"RefNoteID"				/* If present, contains NoteID of folder to use for the base storage information */
...
/* Private view format when workspace is in bookmark.nsf */
#define VIEW_PRIVATE_WS_IN_BOOKMARKS	"($[%h]%s)"				/* %h = Replica Id and %s = View Name */
...
#define	SERVER_JAVASCRIPTLIBRARY_CODE  "$ServerJavaScriptLibrary"
...
#define DEFAULT_XPAGE_ITEM "$DefaultClientXPage"
#define DEFAULT_WEB_XPAGE_ITEM "$DefaultXPage"
#define ICON_TEMPLATEMODTIME_ITEM "$TemplateModTime"
#define ICON_PIRCREFRESHMODTIME_ITEM "$PIRCRefreshModTime"	/* The highest known common denominator of design refresh on all replicas */
...
#define DAOS_ICON_ITEM "$Daos"
#define DB_THEME_NAME	"$DBTheme"
#define DB_DEFAULT_JSLIB "$JSLibName"
#define DB_NEW_HTML	"$AllowPost8HTML"
#define DB_WEB_EXPIRES_CSS "$CSSExpires"
#define DB_WEB_EXPIRES_JS  "$JSExpires"
#define DB_WEB_EXPIRES_IMAGE	"$ImageExpires"
#define DB_WEB_EXPIRES_FILE		"$FileExpires"
#define CS_AUTO_ICON_ITEM 		"$CS_AUTO"		/* CS autoprocessing enabled */
#define LAUNCH_XPAGE_RUNONSERVER "$LaunchXPageRunOnServer"
#define LARGE_SUMMARY_ICON_ITEM	"$LargeSummary"

/* These Icon Item states should be used for all new style icon items
	which replace icon flags  (not specific to DAOS ) */
#define ICON_ITEM_DISABLED  "0"
#define ICON_ITEM_ENABLED   "1"
#define ICON_ITEM_LEN        1

/* DAOS icon item names kept for compatibility */
#define DAOS_ICON_DISABLED  ICON_ITEM_DISABLED
#define DAOS_ICON_ENABLED   ICON_ITEM_ENABLED
#define DAOS_ICON_LEN       ICON_ITEM_LEN

#define DISALLOW_OPENINNBP_ICON_ITEM "$DisallowOpenInNBP"
#define DISALLOW_OPEN_IN_NBP_ENABLED	ICON_ITEM_ENABLED
#define DISALLOW_OPEN_IN_NBP_DISABLED	ICON_ITEM_DISABLED

#define DISABLE_EXPORT_ICON_ITEM	"$DisableExport"

/* Disable Export icon item specifics */
#define DISABLE_EXPORT_ENABLED	"1"
#define DISABLE_EXPORT_DISABLED	"0"
#define DISABLE_EXPORT_ICON_LEN	1
...
/*	NOTE: Current flags need to be in synch with the 'fa' array in design\dreplace.c.
            This array is used to prevent design refresh/replace from wiping out flags
            from up-level servers. */
...
/* icon flags */
/* used values: aAbBcCdDeEFfgGhHiIjJKklLmMnoNOpPQrsStTuUvVWwxXyzZ123456789?! */

/* ATTENTION: DISCONTINUE THE USE OF NEW ICON FLAGS IN ALL CODE STREAMS!

   DURING DOWN-VERSION DESIGN REFRESH AND REPLICATION, THE $Flags ITEM IS 
   BEING INCORRECTLY MODIFIED. FOR NEW ICON "CHFLAGs", CREATE A NEW
   ICON NOTE ITEM FOR YOUR ICON AND USE NSFItemGet/Set TO GET, SET
   AND TEST FOR THE ITEM. SEE DAOS_ICON_ITEM ABOVE AND IN THE CODE AS
   A GUIDE. */
...
#define CHFLAG_WEB_LAUNCH_XPAGE			'!'
...
#define	CHFLAG_DISABLE_AUTO_VIEW_UPDS	'0' /* don't have update task update views for this DB (on servers) */
...
#define WEBFLAG_NOTE_USEJSCTL_INBROWSER		'D' /* use JS control to render the view (reuse deployable) */
#define WEBFLAG_NOTE_CRAWLABLE			'C'		/* this view can be crawled */
#define WEBFLAG_NOTE_RESTAPIALLOWED		'A'		/* this view is accessible to rest api */
...
#define DBDIR_NIFNSFSTATE_ITEM	"$NIFNSFSTATE"		/* NIFNSF state */
#define DBDIR_NIFNSFSIZE_ITEM	"$NIFNSFSIZE"		/* NIFNSF size in bytes */
...
#define LOG_SECURITY_FORM	"Security"
...
#define LOG_ITEM_SECURITY_LEVEL		"SecLev"
#define LOG_ITEM_TARGET_SERVER		"TargetServer"
#define LOG_ITEM_TARGET_USER		"TargetUser"
#define LOG_ITEM_TARGET_DB			"TargetDb"
#define LOG_ITEM_TARGET_EXTRA		"TargetExtra"
...
#define CRIT_UPDATE_QUEUE_NAME 	TASK_QUEUE_PREFIX"VIEW INDEXER"		/* Dedicated critical/stale View Indexer */
#define INLINE_UPDATE_QUEUE_NAME 	TASK_QUEUE_PREFIX"INLINEINDEX"		/* Inline View Indexer monitor */
...
#define FIXUP_ASYNC_QUEUE_NAME	TASK_QUEUE_PREFIX"FIXUPASYNC"	/* Fixup async */
...
#define STANDARD_NAB_FILENAME		"names.nsf"					// 
...
#define TRAVELER_ALLOW_ACCESS_ITEM	"tsAllowAccess"
#define TRAVELER_DENY_ACCESS_ITEM	"tsDenyAccess"
...
#define LOCATION_HOLDMAIL	"HoldMail"
...
#define BOOKMARK_HISTORY_FORM                     "HistoryListEntry"
...
#define VIEW_COLUMN_FORMAT_EXT_ITEM		"$ColumnFormatExtItem"
...
#define FOLDER_CALENDAR_API	"($CSAPIs)"
#define FOLDER_MINIVIEW_NOTICES	"Miniview - Notices2"
#define FOLDER_MINIVIEW_FOLLOWUP "MiniView - Followup2"
#define FOLDER_MINIVIEW_TASKS "MiniView - Tasks2"
#define FOLDER_JUNKMAIL			"($JunkMail)"
#define VIEW_FOLLOW_UP			"($Follow-Up)"
#define VIEW_MINIVIEW_PREFIX	"(MiniView - "
#define VIEW_IMTRANSCRIPTS	"($IMTranscripts)"
...
/* Standard Outline names */
#define MAIL_OUTLINE "NotesMailOutlineH"
#define CALENDAR_OUTLINE1 "NotesCalendarOutline"
#define CALENDAR_OUTLINE2 "NotesCalOutline"
#define CONTACTS_OUTLINE1 "Contacts&Groups"
#define CONTACTS_OUTLINE2 "Contact Outline"
#define TODO_OUTLINE "To Do Outline"

/* Federation aliases */
#define SHOW_CALENDARS_ALIAS "$MyCalendars"
#define SHOW_TODOS_ALIAS "$MyToDos"

#define ADD_CALENDAR_ALIAS "$AddInternetCalendar"
#define ADD_TODO_ALIAS "$AddInternetToDo"
#define ADD_MAIL_ALIAS "$AddInternetMail"

#define SHOW_FEDERATIONS_ALIAS "$ShowFederations"
#define ADD_FEDERATED_ENTRY_PARTIAL_ALIAS "$AddInternet"

#define CAL_URL "CalURLs"
#define CONTACT_URL "ContactURLs"
#define TODO_URL "ToDoURLs"
#define FED_CAL_TOKEN_MAP "FedCalTokenMap"
#define HIDDEN_OUTLINE "$AlwaysHiddenOutlineEntry"
...
#define CLUSTERS_NOREPAIR_FIELD		"DoNotRepair"
...
#define USERREG_FOREIGNDN_ITEM			"ForeignDN"
...
/* IMAP DoNotFetch flag. Pseudo notes will be created if this item is set */
#define IMAP_ITEM_DONOTFETCH	  	"IMAPDoNotFetch"
...
#define POLICY_EXT_SETTINGS_FORM		"PolicyExt"
#define POLICY_TRAVELER_SETTINGS_FORM	"PolicyTraveler"
#define POLICY_MAIL_SETTINGS_FORM		"PolicyMail"
#define POLICY_CONNECTIONS_SETTINGS_FORM	"com.ibm.openactivities.client.common"
#define POLICY_ROAMING_SETTINGS_FORM		"com.ibm.rcp.roaming.service"
#define POLICY_SYMPHONY_SETTINGS_FORM		"com.ibm.productivity.tools"
...
#define NOTESEXTERNAL_DOMAIN_TYPE	"LDAP-Notes"
#define NOTESCONFIG_DOMAIN_TYPE	"NOTES-CONFIG"  /* Indicates this is the Notes Configuration portion of a NOTESEXTERNAL_DOMAIN */
#define LDAPNDAUX_DOMAIN_TYPE	"LDAP-IBMNDAUX" /* Indicates this is the LDAP portion of a NOTESEXTERNAL_DOMAIN */
...
#define BROWSERMENUFRAME			"Menubar"
...
#define SEARCH_MESSAGE_STRING "SearchMessageString" /* web adds this for selected search errors */
...
#define ITEM_NAME_IMAGE_URL_SOURCE			"$ImageURLSource"
...
#define IMAGE_NEW_DBICON_NAME	"$DBIcon"	/* the name for 8.5.2 new database icon - we cannot just rename IMAGE_DBICON_NAME. */
...
/* NOTES.INI variable used on server, which enable/disable to check group in ServerConfig */
#define MIME_CHECK_GROUP_ON_SERVER_CONFIG "MIMECheckGroupOnServerConfigEnable"
