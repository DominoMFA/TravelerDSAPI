...
/*                                                                   */
/* Copyright IBM Corp. 1993, 2013  All Rights Reserved.              */
/*                                                                   */
...
#define SETUP_NETWORK_LAST		(PKG_SETUP+90)
	...
	stringtext(SETUP_NETWORK_FIRST+3, "Macintosh|1|TCPIP|TCP, 0, 15, 0|TCP/IP")
...
#define ERR_REG_POLICY_ID_CREATION_NEEDED				(PKG_REG2+16)
    errortext(ERR_REG_POLICY_ID_CREATION_NEEDED, "The effective registration policy 'Create a Notes ID' field must be a checked to support the CA process, DOLS and IBM Notes mail.")
#define ERR_REG_POLICY_ID_IN_NAB_NEEDED					(PKG_REG2+17)
    errortext(ERR_REG_POLICY_ID_IN_NAB_NEEDED, "The effective registration policy 'In Domino Directory' ID storage field must be a checked to support CA process, DOLS and IBM Notes mail.")
...
#define STR_REG_GLOBALRULE_INOTES_HELP			(PKG_REG2 + 46)
	stringtext(STR_REG_GLOBALRULE_INOTES_HELP,	"Global Rule for IBM iNotes Help Files")
