...
/* For Mobile */
#define VCF_HIDE_S_MOBILE				13		/* Hide column on mobile */
#define VCF_HIDE_M_MOBILE				0x2000

/* #define	VCF_HIDE_S_spare 						14 - 15 */
/* #define	VCF_HIDE_M_spare						0x4000 - 0x8000 */
...
/*#define VCF5_S_UserDefinableExtended	5
#define VCF5_M_UserDefinableExtended	0x00000020		   */
...
/* Extended View Column Format for additional View-Column properties in infobox */
typedef struct
	{
	...
	/* formatting data. */
	DWORD	dwFlags6;						
#define	VCF6_S_BeginWrapUnder		0				/* Vertical Layout, Do not wrap under */
#define	VCF6_M_BeginWrapUnder		0x00000001
#define VCF6_S_PublishColumn		1				/* publish this column */
#define VCF6_M_PublishColumn		0x00000002
#define	VCF6_S_ExtendColWidthToAvailWindowWidth		2				/* Extend Col width to available window width */
#define	VCF6_M_ExtendColWidthToAvailWindowWidth		0x00000004
#define VCF6_S_BuildCollationOnDemand 3
#define VCF6_M_BuildCollationOnDemand 0x00000008
#define VCF6_S_UserDefinableExtended	4
#define VCF6_M_UserDefinableExtended	0x00000010
#define VCF6_S_IgnorePrefixes	5
#define VCF6_M_IgnorePrefixes	0x00000020
#define VCF6_S_AbbreviatedDate	6
#define VCF6_M_AbbreviatedDate	0x00000040
#define VCF6_S_AbbreviatedDateSet	7
#define VCF6_M_AbbreviatedDateSet	0x00000080
