...
#define ERR_FAULT_RECOVERY_CRASHREPORTER		PKG_OS+22
	errortext(ERR_FAULT_RECOVERY_CRASHREPORTER,	"The CrashReporter will generate the crash log after you close this dialog. If you are going to send a bug report to HCL, be sure to include the CrashReporter log.")
#if defined(NT)
#define ERR_TERMINATING		PKG_OS+23
	debugtext(ERR_TERMINATING,		"The partition is terminating, new processes are not allowed to start as denoted by presense of termination shared memory for this data directory")
#else
#define ERR_TERMINATING		PKG_OS+23
	debugtext(ERR_TERMINATING,		"The partition is terminating, new processes are not allowed to start as denoted by presence of termination file in the data directory")
#endif
/* PKG_OS+24 available */
/* PKG_OS+25 available */
...
/* SPR JRED8DVKSU*/
#define STR_OS_DEFAULT_DSTLAWTIME			PKG_OS+35
	stringtext(STR_OS_DEFAULT_DSTLAWTIME, 	"02:00;01:00")
...
/* PKG_OS+143 available */
/* PKG_OS+144 available */
...
#define ERR_MEM_HANDLES					PKG_OS+162
	errortext(ERR_MEM_HANDLES,			"Maximum number of memory segments that Notes can support has been exceeded - out of handles")
...
#endif
/* PKG_OS+166 available */
/* PKG_OS+167 available */
...
/* PKG_OS+212 available */
/* PKG_OS+213 available */
...
/* PKG_OS+228 available */
/* PKG_OS+229 available */
...
#define ERR_FAULT_RECOVERY2			PKG_OS+240
	errortext(ERR_FAULT_RECOVERY2,	"Freeing resources|Recovery error|Fault cleanup completed|Termination completed|Domino Halted. Type 'quit' to Terminate/Cleanup |quit|Shutdown system disabled, use 'nsd -kill' to terminate|NSD completed|Show in Finder|Error removing .terminating file")
...
#define FR_IDX_NSDCOMPLETED	8
#define FR_IDX_NSDFINDER	9
#define FR_IDX_ERRREMTERM	10
#define FR_IDX_MAX2			10	/* maximum substring index */
#define ERR_FAULT_RECOVERY3			PKG_OS+241
	errortext(ERR_FAULT_RECOVERY3,	"Server Restart Notification|Fault Recovery Notification: Server %s was restarted after a fault on %s|Running NSD|NSD is collecting crash information, please wait...|NSD has completed. Log has been written to|NSD has completed, but it encountered an error.")
#define FR_IDX_SUBJ	1
#define FR_IDX_BODY	2
#define FR_IDX_RUNNSD	3
#define FR_IDX_NSDNOTE	4	
#define	FR_IDX_NSDGOOD	5	
#define FR_IDX_NSDERROR	6	
#define FR_IDX_MAX3	6	/* maximum substring index */
