...
#define ERR_REG_PROMOTEDN_NOT_FOUND			PKG_REG + 41
	errortext(ERR_REG_PROMOTEDN_NOT_FOUND, "The distinguished name provided for registration could not be found in the directory")
...
/*	NOTE:  PKG_REG+51 through PKG_REG+141 are used by the setup program
	...
	DO NOT USE PKG_REG+51 through PKG_REG+141!
...
#define SETUP_NETWORK_LAST		(PKG_SETUP+90)
	...
	stringtext(SETUP_NETWORK_FIRST+3, "Macintosh;Macintosh/64;iOS|1|TCPIP|TCP, 0, 15, 0|TCP/IP")
	...
	stringtext(SETUP_NETWORK_FIRST+23, "Android|1|TCPIP|TCP, 0, 15, 0|TCP/IP")
...
#define ERR_REG_LOCAL_CACHE_CREATION			(PKG_REG+146)
	errortext(ERR_REG_LOCAL_CACHE_CREATION,		"Error creating local cache for mail file : '%s', Error: %e\n")

#define ERR_REG_KEYRING_EXISTS					(PKG_REG+147)
	errortext(ERR_REG_KEYRING_EXISTS,			"Keyring file or stash file could not be created because an existing file already exists.")

#define ERR_REG_MAB_NO_ENCRYPT					(PKG_REG+148)
	errortext(ERR_REG_MAB_NO_ENCRYPT,			"Directory Assistance configuration could not be encrypted.  Verify the encryption on the configuration is correct.")

#define ERR_REG_ENCRYPTED_DA_DOC				(PKG_REG+149)
	errortext(ERR_REG_ENCRYPTED_DA_DOC,			"This server cannot access the Directory Assistance document required to connect to the foreign directory because the document is encrypted.  To correct this problem add this server's name to the document's 'Public Encryption keys'.")
#define ERR_REG_CONFIG_DA_DB					(PKG_REG+150)
	errortext(ERR_REG_CONFIG_DA_DB,				"Unable to find applicable configuration in Directory Assistance")
#define ERR_REG_CREATING_DA_DB					(PKG_REG+151)
	stringtext(ERR_REG_CREATING_DA_DB,			"Creating Directory Assistance Database...")
...
#define ERR_REG_PROMOTEDN_AMBIG					(PKG_REG + 155)
	errortext(ERR_REG_PROMOTEDN_AMBIG,			"The distinguished name provided for registration matches multiple entries in the directory")
...
#define STR_REG_CREATINGNEWROAMDB		   		(PKG_REG+186)
	stringtext(STR_REG_CREATINGNEWROAMDB, 		"Creating roaming database '%s'...")
#define ERR_REG_ROAMING_CONFLICT				(PKG_REG+187)
	errortext (ERR_REG_ROAMING_CONFLICT, 		"The registration roaming setting conflicts with the roaming policy setting for this user")
#define STR_REG_ROAM_DB_TITLE					(PKG_REG+188)
	stringtext (STR_REG_ROAM_DB_TITLE, 			"Personal Journal|Notebook|Offline Feed Content")
#define IDX_STR_REG_JOURNAL_DB_TITLE			1
#define IDX_STR_REG_NOTEBOOK_DB_TITLE			2
#define IDX_STR_REG_LOCALFEED_DB_TITLE			3

#define STR_REG_ROAMINGDATA_TITLE				(PKG_REG+189)
	stringtext (STR_REG_ROAMINGDATA_TITLE, 		"Roaming User Data")
...
#define ERR_SETUP_UNSUPPORTED_DIR_TYPE	(PKG_REG+248)
	errortext(ERR_SETUP_UNSUPPORTED_DIR_TYPE,	"The type of repository for people and groups is not supported for Domino")
#define STR_REG_DA_TITLE				(PKG_REG+249)
	stringtext(STR_REG_DA_TITLE,		"Directory Assistance for")
...
#define ERR_REG_POLICY_ID_CREATION_NEEDED				(PKG_REG2+16)
    errortext(ERR_REG_POLICY_ID_CREATION_NEEDED, "The effective registration policy 'Create a Notes ID' field must be a checked to support the CA process, DOLS and HCL Notes mail.")
#define ERR_REG_POLICY_ID_IN_NAB_NEEDED					(PKG_REG2+17)
    errortext(ERR_REG_POLICY_ID_IN_NAB_NEEDED, "The effective registration policy 'In Domino Directory' ID storage field must be a checked to support CA process, DOLS and HCL Notes mail.")
...
#define ERR_REG_PROMOTEDN_NONPRIMARY		(PKG_REG2 + 21)
	errortext(ERR_REG_PROMOTEDN_NONPRIMARY,	"The distinguished name provided for registration matches an entry in a non-primary directory")
#define ERR_REG_PROMOTEDN_EXISTING			(PKG_REG2 + 22)
	errortext(ERR_REG_PROMOTEDN_EXISTING,	"The distinguished name provided for registration matches an existing Domino person")
...
#define ERR_REG_DNREQUIRED			(PKG_REG2 + 25)
	errortext(ERR_REG_DNREQUIRED, "A distinguished name is required for registration")
...
#define STR_REG_GLOBALRULE_INOTES_HELP			(PKG_REG2 + 46)
	stringtext(STR_REG_GLOBALRULE_INOTES_HELP,	"Global Rule for HCL iNotes Help Files")
...
#define	ERR_REG_BAD_ASP_SETUP				(PKG_REG2+62)
	errortext(ERR_REG_BAD_ASP_SETUP,		"The Domino Directory is missing a required item (created during setup)")
...
stringtext (STR_REG_BOOKMARK_DB_TITLE, 		"Bookmarks")
...
#define	ERR_REG_INSUFFICIENT_DISK_SPACE_FOR_CACHE	(PKG_REG2+96)
	errortext(ERR_REG_INSUFFICIENT_DISK_SPACE_FOR_CACHE,	"Insufficient disk space. Please try later.")
#define STR_REG_APPLICATIONS_BM					(PKG_REG2+97)
	stringtext(STR_REG_APPLICATIONS_BM,	"Applications")
