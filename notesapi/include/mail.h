...
#define MAIL_PARTIALSENT_ITEM_NUM 50			/* Email doc sent to internal users but not sent to internet users */

#define MAIL_ITEMS 51							/* Number of items */
...
#define MAIL_TEMPLATE_NAME "mail11.ntf"
#define MAILEX_TEMPLATE_NAME "mail8ex.ntf"
#define MAIL_INOTES_TEMPLATE_NAME "mail11.ntf"
