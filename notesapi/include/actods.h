...
#define		ACTION_ODS_FLAG_MASK			0xF5F9F1FF /* need update to include the bitwise flags for the Flags field. ex. one for LI 4602.02 */ 
...
#define ACTION_BAR_FLAG_USE_JSCONTROL		0x00008000	/* use a JS (dojo) control to render the action bar on the web */
#define ACTION_BAR_FLAG_USE_CUSTOMJS		0x00010000	/* use a custom js control to render the action bar on the web */
