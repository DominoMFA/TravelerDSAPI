...
#define ERR_QUERY_UNKNOWNTERM	PKG_AGENTS+3
	errortext(ERR_QUERY_UNKNOWNTERM,	"This search cannot be recognized by this version of HCL Notes.")
#define ERR_ACTION_UNKNOWNTERM	PKG_AGENTS+4
	errortext(ERR_ACTION_UNKNOWNTERM,	"This action cannot be recognized by this version of HCL Notes.")
...
#define ERR_ACCESS_OLDVERSION		(PKG_AGENTS+83)
	errortext(ERR_ACCESS_OLDVERSION,	"The server is running a previous version of HCL Notes that does not support private agents")
...
#define ERR_AGENT_WRONGVERSION_GENERIC		(PKG_AGENTS3+13)
	errortext(ERR_AGENT_WRONGVERSION_GENERIC,"This version of HCL Notes does not support agents of this version")
