...
// Tivoli Enterprise console is no longer support in ND10, only
// supported on 32 bit server platforms in previous releases
// we would need updated Tivoli libraries to link with to support
// this goiing forward
