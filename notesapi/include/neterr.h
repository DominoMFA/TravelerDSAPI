...
#define	ERR_NETBFR_PTYIELD			PKG_NETWORK+52
	internaltext(ERR_NETBFR_PTYIELD,	"Yield, then call back with same NETBFR quickly")
...
stringtext(STR_RQST3_LIST, "FINDDESIGN_NOTES|GET_DBINFO|DB_GETSET_DEL_SEQNUM|NAME_LOOKUP32|COPY_FILE|GET_DBINFO|GET_OBJECT_INFO_EXT2|COPY_FILE_FROM_SERVER|REPAIR FILE|FILE_EXIST|COPY_FILE_EXT|SAAS_READ_FILE|SAAS_WRITE_FILE")
...
#define IDX_STR_GETOBJECTINFOEXT2_RQST	7
#define IDX_STR_COPY_FILE_FROM_SERVER	8
#define IDX_STR_REPAIR_FILE				9
#define IDX_STR_FILE_EXIST				10
#define IDX_STR_COPY_FILE_EXT			11
#define IDX_STR_SAAS_READ_FILE			12
#define IDX_STR_SAAS_WRITE_EXT			13
...
#define STR_SERVERNAME_MISMATCH						PKG_NETWORK+253
	stringtext(STR_SERVERNAME_MISMATCH,				"Configuration Error: Server record not found. The Server Name in ID file [%A], does not match any Server found in the Domino Directory in the ($Locations) view. Check that the Server name field in the Server record is a hierarchical name.")
...
#define STR_DB_DIRLINK_RQST_LIST					PKG_NETWORK2+94
	stringtext(STR_DB_DIRLINK_RQST_LIST,			"DB_DIRLINK_SET|DB_DIRLINK_GET|DIR_UPDATE_RQST|DIR_GETBYID_RQST|DIR_SEARCH_RQST|DIR_FIND_ADMIN_SERVER_RQST|DIR_FIND_DOMAINS_RQST|DIR_FIND_DOMAIN_INFO_RQST|DIR_GET_DOMAIN_NAME_FROM_DB_HANDLE_RQST")
#define IDX_STR_DIRLINK_SET_RQST		1
#define IDX_STR_DIRLINK_GET_RQST		2
#define IDX_STR_DIR_UPDATE_RQST			3
#define IDX_STR_DIR_GETBYID_RQST		4
#define IDX_STR_DIR_SEARCH_RQST			5
#define IDX_STR_DIR_FIND_ADMIN_SERVER_RQST	6
#define IDX_STR_DIR_FIND_DOMAINS_RQST	7
#define IDX_STR_DIR_FIND_DOMAIN_INFO_RQST	8
#define IDX_STR_DIR_GET_DOMAIN_NAME_FROM_DB_HANDLE_RQST 9
...
#define STR_RQST_LIST								(PKG_NETWORK2+111)
	stringtext(STR_RQST_LIST,						"SET_UNREAD_NOTE_TABLE|RUN_SERVER_AGENT_RQST|COPY_FDO_RQST|GET_FDO_SIZE_RQST|SET_SUPERBLOCK_FDO_RQST|GET_SUPERBLOCK_FDO_RQST|DIR_READ_ENTRIES_RQST|DIR_FIND_ENTRY_RQST")
...
#define IDX_STR_DIR_READ_ENTRIES_RQST	7
#define IDX_STR_DIR_FIND_ENTRY_RQST		8
...
#define STR_RQST2_LIST							(PKG_NETWORK2+124)
	stringtext(STR_RQST2_LIST,					"REGISTER_MONITOR_RQST|DEREGISTER_MONITOR_RQST|MONITOR_GETEVENTS_RQST|SV_INFO_GET_RQST|GET_ARCHIVE_NOTES_RQST|NIF_GET_IDTABLE_RQST|PROFILE_ENUM_RQST|STARTUP_REPL_RQST")
...
#define IDX_STR_STARTUP_REPL_RQST			8
...
#define STR_RQST4_LIST							(PKG_NETWORK3+2)
	stringtext(STR_RQST4_LIST,		 			"GETNOTES_RQST|GETOBJECT_RQST|DB_IMAP_FETCHNOTES_RQST|DB_ARCHIVE_DELETE_NOTES_RQST|DB_PRUNE_NOTES_RQST|DB_MAJMIN_RQST|SERVER_ACL_RQST|GET_POLICY_RQST|AUTH_LOOKUP_RQST")
...
#define IDX_STR_AUTH_LOOKUP_RQST		9
...
#define STR_LOG_COMMIT_THREAD			PKG_NETWORK4+0
	stringtext(STR_LOG_COMMIT_THREAD,	"log.nsf Commit Thread")
...
#define STR_RQST1C_LIST						(PKG_NETWORK5+29)
	stringtext(STR_RQST1C_LIST,				"GET_SUG_RQST|SERVER_GET_DB2_STATUS|NIF_COLLECTION_CURRENT_RQST|IDX_STR_DB2_UDF_CONN_RQST|GET_MODIFIED_UNREADS_RQST|OPEN_NOTE_UNIDNAME_RQST")
...
#define IDX_STR_OPEN_NOTE_UNIDNAME_RQST 6
/* ajk 2/18/09 Archiver provider agnostic API  is submitted commented out */
/* to locate all related code please search for GENARCHIVE string */
#ifdef GENARCHIVE 
#define STR_RQST1C_LIST						(PKG_NETWORK5+29)
	stringtext(STR_RQST1C_LIST,				"GET_SUG_RQST|SERVER_GET_DB2_STATUS|NIF_COLLECTION_CURRENT_RQST|IDX_STR_DB2_UDF_CONN_RQST|GET_MODIFIED_UNREADS_RQST|GEN_ARCHIVE_NOTES_REQ")
#define IDX_STR_GEN_ARCHIVE_NOTES_RQST 6
#endif
...
#define STR_RQST1B_LIST						(PKG_NETWORK5+30)
	stringtext(STR_RQST1B_LIST,				"SCR_RQST|DB2_RELOCATE_CONT_RQST|DB2_UDF_NOTE_UPDATE_RQST|GETSET_FOLDERINFO_RQST|ID_EXTRA_RQST|JS_GETSCHED_RQST|LOG_SEARCHR6_MSG_RQST|GETCHANGEDDBS_RQST|DB_MODIFIEDTIME_BYNAME_RQST|GET_DB_MODIFIED_NOTES_INFO_RQST|GETDBCHANGES_RQST|FAULT_INSERTION_RQST|RUN_NSD_RQST")
...
#define IDX_STR_FAULT_INSERTION_RQST			12
#define IDX_STR_RUN_NSD_RQST				13
...
/* Package PKG_NET_STR starts here. These are string, non-error codes. */

#define STR_NET_SUGGEST_SSL_SESSION_SIZE		(PKG_NET_STR+0)
	errortext (STR_NET_SUGGEST_SSL_SESSION_SIZE,		"New SSL session data length of %u bytes is larger than the current size of %u bytes.")
#define STR_NET_SUGGEST_SSL_SESSION_SIZE2		(PKG_NET_STR+1)
	errortext (STR_NET_SUGGEST_SSL_SESSION_SIZE2,	"You may want to set the Notes.ini variable SSL_SESSION_SIZE to at least %u bytes.")
#define STR_NET_NUM_LARGER_SSL_SESSIONS			(PKG_NET_STR+2)
	errortext (STR_NET_NUM_LARGER_SSL_SESSIONS, "Number of new SSL sessions larger than the default size since %z: %u")
/* PKG_NET_STR last code is +255 */
