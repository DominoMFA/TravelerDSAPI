...
#define PKG_DIR			0x07d8	/* Directory Independent Package 0-39 */
...
#define PKG_MOBILE_GEOGPS	0x1400	/* NotesGPS Frontend error codes - limit to 0-63 */
#define PKG_UNUSED_1		0x1440		/* Limit this to 0 - 63 */
#define PKG_UNUSED_2		0x1480		/* Limit this to 0 - 63 */
#define PKG_UNUSED_3		0x14C0		/* Limit this to 0 - 63 */
...
#define PKG_XML			0x1B00		/* XML codes: limit to 0 - 235 */
#define PKG_DAOS2		0x1BEB		/* DAOS2 codes: limit to 0 - 4 */
#define PKG_DAOS		0x1BF0		/* DAOS codes: limit to 0 - 15 */
...
#define	PKG_XPC			0x2100	/* Feature is no longer used and deprecated, leave in until code is removed */
...
#define PKG_RDBGERR		0x2D80		/* for remote debug err messages 0-63 */
#define PKG_NSF10		0x2DC0		/* PGK_NSF10 err messages 0-63 */
...
#define PKG_DB2NSF		0x3B00		/* DB2NSF stuff 				0 - 191	[0x3B00 - 0x3BBF] */

#define	PKG_ADPWS		0x3BC0		/* Active Directory Password sync 0 - 31 [0x3BC0 - 0x3BDF] */

#define PKG_DIREX		0x3BE0		/* Directory Extension Manager 	0 - 31 	[0x3BE0 - 0x3BFF] */
...
#define PKG_DESK_ERR5	0x3C90		/* more Desk limit to 0- 111 */
...
#define PKG_EDIT_ERR3	0x3F00		/* More editor codes limit to 0 - 191*/
