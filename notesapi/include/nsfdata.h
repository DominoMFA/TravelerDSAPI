...
#define EFLAGS_AUTOCOMPRESSED 0x4000 /*used to pass FILEFLAG_AUTOCOMPRESSED flag to NSFNoteAttachFile */
...
#define FILEFLAG_AUTOCOMPRESSED	0x0080 /* file is a folder automaticly compressed by Notes */
...
#define FILEFLAG_TEMP		0x8000	/* In memory only.  Temporary file attachment. */
