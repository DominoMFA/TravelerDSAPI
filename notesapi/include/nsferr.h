...
// DB2 is dead, old error strings can all map to a anything until they can be removed from pack
#define ERR_DB2NSF_NOT_IMPL		PKG_DB2NSF+0
	errortext(ERR_DB2NSF_NOT_IMPL, "DB2 not supported in Domino 10")

#define ERR_DB2NSF_FAILURE				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_CORRUPT				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_CLI_ERROR			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INI					ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_NAME_LENGTH			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DAV_NOENCRYPT		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DAV_NOENCRYPT_DESIGN	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_PARMS_NEEDED			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SUM_NOTE_SET			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_NIF_READONLY			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_ACCESS_ROWLEN		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_ACCESS_DEFTYPES		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_ACCESS_FIELDLEN		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INVALID_LENGTH_READ	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_NOT_ENABLED_FOR_DB2	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_CANNOT_USE_DATASTORE	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_TABLESPACE_IN_USE	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_XLATE_POOLFULL		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_TASKTRACK			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_TASKTRACK_FAIL		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SPECIAL_FIELD_ERR	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_BAD_NAME				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_QV_MAX_ROWS			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_REBALANCE			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_WARNING				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_NODATA				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DYNAMIC_SQL			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_CONNECTION			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_TRIGGER				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_FEATURE				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_TYPE					ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SCHEMA				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_TOKEN				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_0K00					ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_TRIG_PROHIBIT		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_CASE					ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_CARDINALITY			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DATA					ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_CONSTRAINT			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_CURS_STATE		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_TRAN_STATE		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_STMT_ID			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_AUTH_SPEC		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_TRAN_TERMINATION	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_CONN_NAME		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_CURS_NAME		ERR_DB2NSF_NOT_IMPL	 // DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_36001				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SYNTAX				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_EXT_FUNC_EX			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_EXT_FUNC_CALL_EX		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SAVEP_EX				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SERIALIZATION		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_AUTHORIZATION		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_VIEW_DEF				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_46XXX				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_APP_STATE		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DUP_UNDEF_NAME		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_INV_OPERAND			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_LIMIT_EXCEEDED		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_PREREQ_STATE			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_MISC_RESTRICTIONS	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_RESOURCE				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SYSTEM				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_NOXMLMAP				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_MAPSUCCESS			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_XML_PARSE			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_GENERIC_FAILURE		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define	ERR_DB2NSF_TABLESPACE_MISSING	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_SCHEMA_MISSING		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DAVPOP_BUSY			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2_MULTIPLENAMES			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_BUFFERPOOL			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2WRITE_RNOTE				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2GET_NSF_SIZE				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2CREATEDB2				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_WRONGSCHEMA			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2ACC_CN_NAME				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2ACC_DB2_NAME				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2_DB2ACCESSMAPPEDERR		ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DB2_CFG_SET			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_FORMAT				ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_DAVVERSION			ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
#define ERR_DB2NSF_XACL_NOT_SUPPORTED	ERR_DB2NSF_NOT_IMPL	// DB2 is dead, aliased to avoid build errors until it is ripped out
		
	
#define ERR_REPAIR_NO_AVAILABLE_DONORS	PKG_DB2NSF+1
	errortext(ERR_REPAIR_NO_AVAILABLE_DONORS, "There are no available repair donors for this server")

#define ERR_D10_LIMIT_EXCEEDED			PKG_DB2NSF+2
	errortext(ERR_D10_LIMIT_EXCEEDED, "The number of clustermates defined exceeds the maximum allowed")

#define ERR_REPAIR_INIT					PKG_DB2NSF+3
	errortext(ERR_REPAIR_INIT, "An error occurred when initializing the repair engine.. repair services will be unavailable")

#define ERR_INTERFACE_UNAVAILABLE		PKG_DB2NSF+4
	errortext(ERR_INTERFACE_UNAVAILABLE,"An unexpected error occurred when acquiring a required interface")

#define ERR_NO_WORKER_AVAIL				PKG_DB2NSF+5
	errortext(ERR_NO_WORKER_AVAIL,	"There are no available workers for this repair request")

#define STR_REPAIR_DISABLED				PKG_DB2NSF+6
	stringtext(STR_REPAIR_DISABLED, "Auto Repair is currently disabled\n")

#define STR_REPAIR_NO_FOLDERS			PKG_DB2NSF+7
	stringtext(STR_REPAIR_NO_FOLDERS, "No directories being monitored for repair - file cannot be repaired\n")

#define STR_REPAIR_NOT_REPAIRABLE_FILE	PKG_DB2NSF+10
	stringtext(STR_REPAIR_NOT_REPAIRABLE_FILE, "The file %s is not in the list of repairable files or does not exist on any other cluster mate\n")

#define STR_REPAIR_MARKED_DNR			PKG_DB2NSF+12
	stringtext(STR_REPAIR_MARKED_DNR, "The file %s is marked as 'Do not repair'\n")

#define STR_REPAIR_CANNOT_QUEUE			PKG_DB2NSF+13
	stringtext(STR_REPAIR_CANNOT_QUEUE, "Unable to queue repair request for %s : %e\n")

#define STR_REPAIR_QUEUED_REQUEST		PKG_DB2NSF+14
	stringtext(STR_REPAIR_QUEUED_REQUEST, "Queued repair request for %s\n")

#define STR_REPAIR_LIST_ONLY			PKG_DB2NSF+15
	stringtext(STR_REPAIR_LIST_ONLY, "%s needs to be repaired but Auto Repair is configured to list only \n")

#define STR_REPAIR_CHECK_EXISTS			PKG_DB2NSF+16
	stringtext(STR_REPAIR_CHECK_EXISTS, "Unexpected error checking if %s exists : %e\n")

#define STR_REPAIR_NO_MISSING			PKG_DB2NSF+17
	stringtext(STR_REPAIR_NO_MISSING, "No missing files to repair for server %s\n")

#define ERR_READING_CONFIG				PKG_DB2NSF+18
	errortext(ERR_READING_CONFIG, "Error trying to read repair configuration [%e]\n")

#define STR_REPAIR_AUTOREPAIR			PKG_DB2NSF+19
	stringtext(STR_REPAIR_AUTOREPAIR, "\n*** AutoRepair ***\n")

#define STR_REPAIR_AUTOREPAIR_DISABLED	PKG_DB2NSF+20
	stringtext(STR_REPAIR_AUTOREPAIR_DISABLED, "\tMissing File Repair\t\tDisabled\n")
...
#define STR_REPAIR_AUTOREPAIR_LIST		PKG_DB2NSF+25
	stringtext(STR_REPAIR_AUTOREPAIR_LIST, "\tMissing File Repair\t\tList Only\n")
...
#define STR_REPAIR_AUTOREPAIR_ENABLED    PKG_DB2NSF+31
	stringtext(STR_REPAIR_AUTOREPAIR_ENABLED, "\tMissing File Repair\t\tEnabled\n")

#define STR_REPAIR_SYNC_ALL_FOLDERS		PKG_DB2NSF+32
	stringtext(STR_REPAIR_SYNC_ALL_FOLDERS, "\tSyncAllFolders\t\t\tYes\n")

#define STR_REPAIR_SELECTED_FOLDERS		PKG_DB2NSF+33
	stringtext(STR_REPAIR_SELECTED_FOLDERS, "\tSelected Folders\t\t%s\n")

#define STR_REPAIR_AUTOREPAIR_SCAN_INTERVAL	PKG_DB2NSF+34	
	stringtext(STR_REPAIR_AUTOREPAIR_SCAN_INTERVAL, "\tLook for missing files every\t%d\tminutes\n")

#define STR_REPAIR_DAMAGED_REPAIR_HDR		PKG_DB2NSF+35   
	stringtext(STR_REPAIR_DAMAGED_REPAIR_HDR, "\n*** Damaged File Repair ***\n")

#define STR_REPAIR_DAMAGED_REPAIR            PKG_DB2NSF+47
	stringtext(STR_REPAIR_DAMAGED_REPAIR, "\tDamaged File Repair\t\t%s\n")

#define  STR_REPAIR_DAMAGED_CLEAN_INTERVAL			PKG_DB2NSF+48
	stringtext(STR_REPAIR_DAMAGED_CLEAN_INTERVAL, "\tDelete damaged 'pd' files after\t%d\tdays\n")

#define  STR_REPAIR_TUNING_HDR			PKG_DB2NSF+49
	stringtext(STR_REPAIR_TUNING_HDR, "\n*** Tuning ***\n")

#define  STR_REPAIR_REPAIR_THREADS			PKG_DB2NSF+50
	stringtext(STR_REPAIR_REPAIR_THREADS, "\tRepair threads\t\t\t%d\n")

#define  STR_REPAIR_DONOR_CHECK_INTERVAL			PKG_DB2NSF+51
	stringtext(STR_REPAIR_DONOR_CHECK_INTERVAL, "\tCheck donor availability every\t%d\tminutes\n")

#define  STR_REPAIR_RETRY_FAIL_INTERVAL			PKG_DB2NSF+52
	stringtext(STR_REPAIR_RETRY_FAIL_INTERVAL, "\tRetry failed repairs after\t%d\tminutes\n")

#define  STR_REPAIR_MAX_RETRIES			PKG_DB2NSF+53
	stringtext(STR_REPAIR_MAX_RETRIES, "\tMaximum number of retries\t%d\n")

#define  STR_REPAIR_PERFORMANCE			PKG_DB2NSF+54
	stringtext(STR_REPAIR_PERFORMANCE, "\tRepair Performance\t\t%d\t( 1=slowest->5=fastest)\n")

#define  STR_REPAIR_LOGGING_LEVEL		PKG_DB2NSF+55
	stringtext(STR_REPAIR_LOGGING_LEVEL, "\tLogging Level\t\t\t%d\t(1=least->10=most)\n\n")

#define  STR_REPAIR_MISSING_FILENAME			PKG_DB2NSF+56
	stringtext(STR_REPAIR_MISSING_FILENAME, "REPAIR: No filename provided\n")

#define  STR_REPAIR_FILE_SUCCESS			PKG_DB2NSF+57
	stringtext(STR_REPAIR_FILE_SUCCESS, "REPAIR: %d file(s) queued for repair\n")

#define  STR_REPAIR_FILE_FAIL		PKG_DB2NSF+58
	stringtext(STR_REPAIR_FILE_FAIL, "REPAIR: repair call failed with error: %e\n")

#define  STR_REPAIR_ALL_ENABLE_DISABLE			PKG_DB2NSF+59
	stringtext(STR_REPAIR_ALL_ENABLE_DISABLE, "%s repair for all replicas of %s\n")

#define  STR_REPAIR_FATAL_ERROR			PKG_DB2NSF+60
	stringtext(STR_REPAIR_FATAL_ERROR,	 "Unrecoverable error occurred in Repair Server\n")

#define  STR_REPAIR_ENGINE_STARTED			PKG_DB2NSF+61
	stringtext(STR_REPAIR_ENGINE_STARTED, "Repair service started\n")

#define  STR_REPAIR_QUEUE_DUMP_HDR			PKG_DB2NSF+62
	stringtext(STR_REPAIR_QUEUE_DUMP_HDR, "***** Summary of '%s' Queue *****\n")

#define  STR_REPAIR_QUEUE_DUMP_EMPTY		PKG_DB2NSF+63
	stringtext(STR_REPAIR_QUEUE_DUMP_EMPTY, "***** Queue is empty *****\n")

#define  STR_REPAIRDIAG_MISSING_NLO		PKG_DB2NSF+64
	stringtext(STR_REPAIRDIAG_MISSING_NLO, "Database %s references missing NLO %s, queuing repair request.")

#define  STR_REPAIRDIAG_WORKBEGIN			PKG_DB2NSF+65
	stringtext(STR_REPAIRDIAG_WORKBEGIN, "Repair request started, total active requests %d")

#define  STR_REPAIRDIAG_WORKEND		PKG_DB2NSF+66
	stringtext(STR_REPAIRDIAG_WORKEND, "Repair request complete, total active requests %d")

#define  STR_REPAIRDIAG_DAOSSKIP 	PKG_DB2NSF+67
	stringtext(STR_REPAIRDIAG_DAOSSKIP, "Scanning DAOS objects for %s [%s] skipped by ini")

#define  STR_REPAIRDIAG_DAOSSCAN		PKG_DB2NSF+68
	stringtext(STR_REPAIRDIAG_DAOSSCAN, "Scanning %d DAOS objects for %s [%s]")

#define  STR_REPAIRDIAG_RENAMEEXISTS		PKG_DB2NSF+69
	stringtext(STR_REPAIRDIAG_RENAMEEXISTS, "Repair rename determined that file %s already exists, assume it has been repaired by another thread - abandoning this repair request")

#define  STR_REPAIRDIAG_FROM			PKG_DB2NSF+70
	stringtext(STR_REPAIRDIAG_FROM, "%s from %s")

#define  STR_REPAIRDIAG_COPY_FROM_ERROR			PKG_DB2NSF+71
	stringtext(STR_REPAIRDIAG_COPY_FROM_ERROR, "[%e] copying %s from %s")

#define  STR_REPAIRDIAG_SUCCESS			PKG_DB2NSF+72
	stringtext(STR_REPAIRDIAG_SUCCESS, "%s Successfully repaired")

#define  STR_REPAIRDIAG_REPAIR_ERROR		PKG_DB2NSF+73
	stringtext(STR_REPAIRDIAG_REPAIR_ERROR, "Error [%e] repairing %s from %s")

#define  STR_REPAIRDIAG_ADD_CONDITIONAL			PKG_DB2NSF+74
	stringtext(STR_REPAIRDIAG_ADD_CONDITIONAL, "Adding conditional reference to object %s for database %s")

#define  STR_REPAIRDIAG_FILE_UNUSABLE		PKG_DB2NSF+75
	stringtext(STR_REPAIRDIAG_FILE_UNUSABLE, "File %s was copied from donor but is unusable!")

#define  STR_REPAIRDIAG_NLO_FAIL_1		PKG_DB2NSF+76
	stringtext(STR_REPAIRDIAG_NLO_FAIL_1, "%s - NLO %s could not be repaired (Error-%d) and is being skipped: ")

#define  STR_REPAIRDIAG_NLO_FAIL_2			PKG_DB2NSF+77
	stringtext(STR_REPAIRDIAG_NLO_FAIL_2, "%s - NLO %s could not be repaired (Error-%d), failure %d of max %d skipped")

#define  STR_REPAIRDIAG_NLO_FAIL_3			PKG_DB2NSF+78
	stringtext(STR_REPAIRDIAG_NLO_FAIL_3, "%s - NLO %s could not be repaired (Error-%d), failure %d exceeds max %d, stopping")

#define  STR_REPAIRDIAG_NLO_COMPLETE_WITH_STATUS		PKG_DB2NSF+79
	stringtext(STR_REPAIRDIAG_NLO_COMPLETE_WITH_STATUS, "%s repair completed with status:%e")

#define  STR_REPAIRDIAG_FILE_NOT_REPAIRABLE		PKG_DB2NSF+80
	stringtext(STR_REPAIRDIAG_FILE_NOT_REPAIRABLE, "File %s cannot be repaired [%e]")

#define  STR_REPAIRDIAG_MAX_RETRIES			PKG_DB2NSF+81
	stringtext(STR_REPAIRDIAG_MAX_RETRIES, "File %s has exceeded the maximum number of repair retries %d")

#define  MPFXID_ERROR		PKG_DB2NSF+82
	stringtext(MPFXID_ERROR, "*Error*")

#define  MPFXID_COPYING		PKG_DB2NSF+83
	stringtext(MPFXID_COPYING, "*Copying*")

#define  MPFXID_REPAIRED		PKG_DB2NSF+84
	stringtext(MPFXID_REPAIRED, "*Repaired*")

#define  MPFXID_COPY_COMPLETE			PKG_DB2NSF+85
	stringtext(MPFXID_COPY_COMPLETE,		"*Copy Completed*")

#define  MPFXID_REPAIR_FAILED			PKG_DB2NSF+86
	stringtext(MPFXID_REPAIR_FAILED,		"*Repair Failed*")

#define  MPFXID_POST_PROCESS			PKG_DB2NSF+87
	stringtext(MPFXID_POST_PROCESS,		"*Post Process*")

#define  MPFXID_SCAN_DAOS			PKG_DB2NSF+88
	stringtext(MPFXID_SCAN_DAOS,	"*Scan DAOS*")

#define  MPFXID_FAILED_RETRY			PKG_DB2NSF+89
	stringtext(MPFXID_FAILED_RETRY, 	"*Retry File Copy*")

#define  ERR_REPAIR_DONOR_INACTIVE		PKG_DB2NSF+90
	errortext(ERR_REPAIR_DONOR_INACTIVE, "Specified donor server is not a current clustermate.")
...
#define  ERR_REPAIR_UPDATING_CLDBDIR	PKG_DB2NSF+93
	errortext(ERR_REPAIR_UPDATING_CLDBDIR,	"Unable to update cluster directory while processing delete for database %s.  Line: %d, Error: %e.")
...
#define ERR_NOT_REPAIR_ELIGIBLE_OTHER			PKG_DB2NSF+98
		errortext(ERR_NOT_REPAIR_ELIGIBLE_OTHER, "Databases using NSF-DB2 or Single Common Object Store are not eligible for repair.")
#define ERR_NOT_REPAIR_ELIGIBLE_NIFNSF			PKG_DB2NSF+99
		errortext(ERR_NOT_REPAIR_ELIGIBLE_NIFNSF, "Databases using NIFNSF (external indexes) are not eligible for repair.")
#define ERR_NOT_REPAIR_ELIGIBLE_ENCRYPT			PKG_DB2NSF+100
		errortext(ERR_NOT_REPAIR_ELIGIBLE_ENCRYPT, "Locally encrypted databases are not eligible for repair.")

#define ERR_DAOS_T2_NOT_AVAILABLE		PKG_DB2NSF+101
	errortext(ERR_DAOS_T2_NOT_AVAILABLE,	"DAOS Tier 2 storage services are not available." )
...
#define STR_REPAIR_FILE_EXISTS			PKG_DB2NSF+105
		stringtext(STR_REPAIR_FILE_EXISTS, "File %s already exists, no repair necessary.%s")

#define ERR_REPAIR_IS_DIRECTORY			PKG_DB2NSF+106
		errortext(ERR_REPAIR_IS_DIRECTORY, "Can not repair a directory")

#define ERR_DAOSMGR_CRED_SYNTAX				PKG_DB2NSF+107
		errortext(ERR_DAOSMGR_CRED_SYNTAX,	"DAOS: Invalid syntax for credential file.")
#define ERR_DAOSMGR_CMD_ERROR				PKG_DB2NSF+108
		errortext(ERR_DAOSMGR_CMD_ERROR,	"DAOS:  Command: %1$s: Error: %2$e." )
#define ERR_DAOSMGR_INVALIDCMD				PKG_DB2NSF+109
		errortext(ERR_DAOSMGR_INVALIDCMD, "DAOS: Invalid command line option.")
#define ERR_DAOSMGR_INIT					PKG_DB2NSF+110
		errortext(ERR_DAOSMGR_INIT, "DAOSMGR: DAOS initialization failure.")
#define STR_REPAIR_QUEUE_FULL			PKG_DB2NSF+111
		stringtext(STR_REPAIR_QUEUE_FULL, "The repair queue is full.  %d requests could not be queued at this time.  Try again later.\n")
#define ERR_DAOSMGR_MQGET					PKG_DB2NSF+112
		errortext(ERR_DAOSMGR_MQGET, "DAOS: MQGET error.")
#define ERR_DAOSMGR_CONSOLE_COMMAND_MQ		PKG_DB2NSF+113
		errortext(ERR_DAOSMGR_CONSOLE_COMMAND_MQ, "DAOS: Console MQ error.")
#define ERR_DAOSMGR_ALREADY_RUNNING			PKG_DB2NSF+114
		errortext(ERR_DAOSMGR_ALREADY_RUNNING, "DAOSMGR: Another task instance is already running, exiting.")
#define ERR_DAOSMGR_MQ_EMPTY				PKG_DB2NSF+115
		errortext(ERR_DAOSMGR_MQ_EMPTY, "DAOS: MQ empty.")
#define ERR_DAOS_OPEN_CRED_STORE			PKG_DB2NSF+116
		errortext(ERR_DAOS_OPEN_CRED_STORE, "Error opening credential store %1$s: %2$e\n")
#define ERR_DAOSMGR_MISSING_PARAM			PKG_DB2NSF+117
		errortext(ERR_DAOSMGR_MISSING_PARAM,"DAOSMGR: Missing command argument - use TELL DAOSMGR HELP for valid syntax")
#define ERR_DAOSMGR_CRED_EXISTS				PKG_DB2NSF+118
		errortext(ERR_DAOSMGR_CRED_EXISTS,	"Specified credential already exists in the credential store")
#define ERR_DAOSMGR_PARAM_IGNORED			PKG_DB2NSF+119
		errortext(ERR_DAOSMGR_PARAM_IGNORED,"DAOSMGR: Warning: Extra command parameters were ignored\n")

#define ERR_DAOST2_INVALID_ENDPOINT			PKG_DB2NSF+120
		errortext(ERR_DAOST2_INVALID_ENDPOINT, "Invalid endpoint - Please set a valid endpoint in DAOS Tier 2 settings and restart Domino\n")

/* there may be some available PKG_DB2NSF offsets above... */
/* this is the *current* max; PKG_DB2NSF offsets range from 0 to 223 */
#define ERR_DB2NSF_MAX				PKG_DB2NSF+121
...
#define ERR_UNSUPPORTED_MAIL_OPERATION		PKG_FORMULA+112
	errortext (ERR_UNSUPPORTED_MAIL_OPERATION,	"Mail operation is not supported.")
...
#define ERR_TIME_LIMIT_EXCEEDED PKG_NSF+15
	errortext(ERR_TIME_LIMIT_EXCEEDED,	"Operation time limit exceeded")
...
#define ERR_NOTES_NOT_INITIALIZED	PKG_NSF+23
	errortext(ERR_NOTES_NOT_INITIALIZED,"Notes needs to be initialized before calling into NSF")
...
#define	ERR_INVALID_NAME	PKG_NSF+47
	errortext(ERR_INVALID_NAME,"Remote pathnames must be relative to the Data directory")
...
#define ERR_FORM_DELETED		PKG_NSF+130
	errortext(ERR_FORM_DELETED,"Form has been deleted. The application design may be out of date.  Try updating the application design.")
...
#define	ERR_FILEMAX				PKG_NSF+133
	errortext(ERR_FILEMAX,		"Database (.nsf) has grown too large; use compact to reduce the file size or use File New Replica to recreate your file with larger capacity.")
...
#define ERR_DB_DESIGN_COMPRESSION_DISABLED	PKG_NSF+164
	errortext(ERR_DB_DESIGN_COMPRESSION_DISABLED, "Database design compression has been disabled for %p")
#define ERR_ALREADY_ALLOC		PKG_NSF+165
	errortext(ERR_ALREADY_ALLOC,	"(RRV already allocated)")
...
#define ERR_SKIP				PKG_NSF+205
	errortext(ERR_SKIP,		"Stop operation started at your request")
...
#define ERR_DAOS_OVER_MAXDB_SIZE		PKG_NSF2+126
	errortext(ERR_DAOS_OVER_MAXDB_SIZE, 	"Compacting this DAOS enabled database back in-line will cause the overall size of the database to exceed the maximum database size.")
...
#define ERR_RM_LOG_FULL					PKG_NSF3+68
	errortext(ERR_RM_LOG_FULL,			"Recovery Manager: Log File is Full")
...
#define ERR_RM_SCAN_IN_PROGRESS			PKG_NSF3+104
	errortext(ERR_RM_SCAN_IN_PROGRESS, 	"Recovery Manager: Log scan in progress.")
...
#define ERR_NOT_LOCK_DB					PKG_NSF3+124
	errortext(ERR_NOT_LOCK_DB,			"Attempted a lock operation on a DB that does not support locking.")
...
#define NSFSTR_TRANSLOG_DAMAGED			PKG_NSF5+5
	stringtext(NSFSTR_TRANSLOG_DAMAGED,	"Error encountered reading transaction log!")
...
/** #define	ERR_SCOS_NUM_FILES_REQ "\nRequested files (%d) for %s exceeds the server maximum %d files.\nCreating: %d file(s).\n" temp hack for build failure. **/
#define ERR_QUEP_MAX_SCANS_EXCEEDED	PKG_NSF7+11
	errortext(ERR_QUEP_MAX_SCANS_EXCEEDED, "Maximum number of documents or view entries scanned for query exceeded")
...
#define ERR_DB_DATA_COMPRESSION_DISABLED	PKG_NSF8+70
	errortext(ERR_DB_DATA_COMPRESSION_DISABLED,	"Database document compression has been disabled for %p")
...
#define ERR_SCOS_FILE	PKG_NSF8+83
	errortext(ERR_SCOS_FILE, "%s is linked to shared mail, please unlink this database from shared mail.\n | %s is used for shared mail storage, please unlink mail files from this database.\n")
#define IDX_SCOS_FILE_MAIL         1
#define IDX_SCOS_FILE_STORE        2
...
#define ERR_CACHEFAILURE					PKG_NSF9+30
	errortext(ERR_CACHEFAILURE,				"An error has occurred which will affect performance.  %s will be fixed on the next Notes Client restart.")
...
#define ERR_BAD_NSFBLOCK_SIGNATURE			PKG_NSF9+45
	errortext(ERR_BAD_NSFBLOCK_SIGNATURE,			"Incorrect signature found on NSFBlock expected %x found %x.")
#define ERR_SUPERBLOCK_TOO_LARGE			PKG_NSF9+46
	errortext(ERR_SUPERBLOCK_TOO_LARGE,	"Superblock has exceeded its maximum allowable size.")
...
#define ERR_RM_LOG_READ_ONLY					PKG_NSF9+104
	errortext(ERR_RM_LOG_READ_ONLY,	"Recovery Manager: Log File is Read Only due to OS error")
...
#define ERR_NSF_TRAVERSE_DONE					PKG_NSF10+0
	internaltext(ERR_NSF_TRAVERSE_DONE,		"Traverse done")

#define ERR_ARCHIVE_IMPORT_UNEXPECTED_EOD		(PKG_NSF10+1)
	errortext(ERR_ARCHIVE_IMPORT_UNEXPECTED_EOD, "Insufficient data to create note.")
#define ERR_ARCHIVE_NO_PLACEHOLDER				(PKG_NSF10+2)
	errortext(ERR_ARCHIVE_NO_PLACEHOLDER, 	"No placeholder for this item.")
#define ERR_ARCHIVE_INCOMPLETE_NOTE				(PKG_NSF10+3)
	errortext(ERR_ARCHIVE_INCOMPLETE_NOTE, 	"Cannot restore this note because it is missing items that were extracted during archiving")

#define ERR_NSF_ACL_RESET_DDM					(PKG_NSF10+4)
	errortext(ERR_NSF_ACL_RESET_DDM, 		"Fixup has repaired the database %s ACL, which required changing the -Default- access level to Manager.  Be sure to change the -Default- access back to the correct level.")
#define ERR_FREEING_TOO_MANY_PAGES				(PKG_NSF10+5)
	errortext(ERR_FREEING_TOO_MANY_PAGES, 	"%s: Freeing more than %d pages in %p...|%s: Freed %d pages in %p")
#define FREEING_TOO_MANY_PAGES_LOOP		1
#define FREEING_TOO_MANY_PAGES_FINAL	2
#define ERR_ARCHIVE_DECOMPRESSION_RETRY			(PKG_NSF10+6)
	errortext(ERR_ARCHIVE_DECOMPRESSION_RETRY, "Unable to decompress attachment.")
#define ERR_NSF_LOG_FULL_DDM					(PKG_NSF10+7)
	errortext(ERR_NSF_LOG_FULL_DDM, 		"Transaction log full (%s)")
#define ERR_NSF_ACL_ERROR_DDM					(PKG_NSF10+8)
	errortext(ERR_NSF_ACL_ERROR_DDM, 		"The ACL on database %s is damaged.")
#define ERR_CONTAINER_EMPTY						(PKG_NSF10+9)
	errortext(ERR_CONTAINER_EMPTY, "The container is empty")
#define ERR_INVALID_PAINDEX_VERSION				(PKG_NSF10+10)
	errortext(ERR_INVALID_PAINDEX_VERSION, "The protected attachments index has an invalid version")
#define ERR_ARCHIVE_MISSING_FILE				(PKG_NSF10+11)
	errortext(ERR_ARCHIVE_MISSING_FILE, "The file (%s) has been deleted by an external process.")
#define ERR_MAILBOX_NOT_CACHED					(PKG_NSF10+12)
	errortext(ERR_MAILBOX_NOT_CACHED, "Informational, mailbox %p not cached, either downlevel ODS (minimum ODS level supported for mailbox caching %d, found %d) or not transactionally logged")
#define ERR_NSF_BAD_DESIGN_MODIFIED				(PKG_NSF10+13)
	errortext(ERR_NSF_BAD_DESIGN_MODIFIED,	"Invalid DesignModified time (%z) in database %p")
#define ERR_NSF_BAD_DATA_MODIFIED				(PKG_NSF10+14)
	errortext(ERR_NSF_BAD_DATA_MODIFIED,	"Invalid DATAModified time (%z) in database %p")
#define ERR_NSF_BAD_NONDATA_MODIFIED			(PKG_NSF10+15)
	errortext(ERR_NSF_BAD_NONDATA_MODIFIED,	"Invalid NONDATAModified time (%z) in database %p")
#define ERR_NSF_BAD_BUCKET_MODIFIED				(PKG_NSF10+16)
	errortext(ERR_NSF_BAD_BUCKET_MODIFIED,	"Invalid BucketModified time (%z) in database %p")
#define ERR_NSF_BAD_NOTE_MODIFIED				(PKG_NSF10+17)
	errortext(ERR_NSF_BAD_NOTE_MODIFIED,	"Invalid Modified time (%z) in note NT%08X (OF%08lx:%08lx-ON%08lx:%08lx) in database %p")
#define ERR_NSF_BAD_NOTE_LAST_ACCESSED			(PKG_NSF10+18)
	errortext(ERR_NSF_BAD_NOTE_LAST_ACCESSED,	"Invalid LastAccessed time (%z) in note NT%08X (OF%08lx:%08lx-ON%08lx:%08lx) in database %p")
#define ERR_NSF_BAD_NOTE_ADDED_TO_FILE			(PKG_NSF10+19)
	errortext(ERR_NSF_BAD_NOTE_ADDED_TO_FILE,	"Invalid AddedToFile time (%z) in note NT%08X (OF%08lx:%08lx-ON%08lx:%08lx) in database %p")
#define ERR_NSF_BAD_NOTE_SEQUENCE				(PKG_NSF10+20)
	errortext(ERR_NSF_BAD_NOTE_SEQUENCE,	"Invalid Originator.Sequence time (%z) in note NT%08X (OF%08lx:%08lx-ON%08lx:%08lx) in database %p")
#define ERR_FIXUP_REMOVING_REPL_HISTORY_ENTRY	(PKG_NSF10+21)
	errortext(ERR_FIXUP_REMOVING_REPL_HISTORY_ENTRY, "Removing invalid replication history entry for Server:'%s' File:'%s' Time:'%z' in database %p")
#define ERR_COMPACT_DAOS_ATTACHMENTS             (PKG_NSF10+22)
	errortext(ERR_COMPACT_DAOS_ATTACHMENTS,      "Unable to compact attachments into DAOS, database must be upgraded to R85 or later database version")
#define ERR_TXN_LOG_READ_ONLY			PKG_NSF10+23
	errortext(ERR_TXN_LOG_READ_ONLY,	"Transaction log is readonly due to: %e%n")
#define ERR_BACKUP_ABORTED2						 (PKG_NSF10+24)
	errortext(ERR_BACKUP_ABORTED2,		"Backup terminated due to excessive concurrent activity")
#define ERR_NSF_LOG_FILE_FULL_ENDED			PKG_NSF10+25
	errortext(ERR_NSF_LOG_FILE_FULL_ENDED,	"Log File no longer full")
#define ERR_COMPACT_DAOS_ATTACHMENTS2            (PKG_NSF10+26)
	errortext(ERR_COMPACT_DAOS_ATTACHMENTS2,      "Unable to compact attachments into DAOS, transaction logging is disabled for database")
#define ERR_NOTE_PURGE_INSERT						   	PKG_NSF10+27
	errortext(ERR_NOTE_PURGE_INSERT,  "Warning: Fixup purged corrupt document UNID (%h:%h) from %p")
#define ERR_NOTE_PURGE_RESTORE						   	PKG_NSF10+28
	errortext(ERR_NOTE_PURGE_RESTORE, "Informational: Replication restored document UNID (%h:%h) by %p to %p")
#define ERR_NOTE_PURGE_EXPIRE						   	PKG_NSF10+29
	errortext(ERR_NOTE_PURGE_EXPIRE,  "Warning: Replication did not restore corrupt document, time expired, UNID (%h:%h) from %p")
#define ERR_FILE_EXISTS_DIFFERENT_CASE		PKG_NSF10+30
	errortext	(ERR_FILE_EXISTS_DIFFERENT_CASE, "Failed to create database, can not create multiple databases that differ only in case.")

#define ERR_RM_SNAPSHOT_INVALID_DB			PKG_NSF10+31
	errortext(ERR_RM_SNAPSHOT_INVALID_DB,	"SnapShots from different backups not supported - %p%n")

/* Use these very, very sparingly...and make sure you need them ! */

/* PKG_NSF10 codes limited to 0-31 */
...
#define DB2STR_CFG_SET_ERR			    PKG_DB2_STR+33
	stringtext(DB2STR_CFG_SET_ERR,	    "DB2NSFInit Error setting configuration parameters for DB2 database %s sqlcode=%d.")
...
#define STR_DB2_KEY_WARNING		PKG_DB2_STR+51
    stringtext(STR_DB2_KEY_WARNING, "NSFDB2 is under a limited availability program. If you wish to continue using NSFDB2, Please, contact support for a license key.")
